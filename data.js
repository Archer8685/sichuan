const PLACES = [
 ...
 },
 {
  ...
  "notes": "品牌公開資料確認成都天府廣場旗艦店於2025年開業；未查得可靠營業時間與評分，出發前請以大眾點評門店頁為準。"
 },
 {
  "name": "清真老皇城牛肉館",
  "city": "成都",
...
const T2S = {"麵": "面", "裡": "里", "遊": "游", "隻": "只", "乾": "干", "後": "后", "髮": "发", "於": "于", "臺": "台", "嚐": "尝", "賀": "贺", "餵": "喂", "關": "关", "漢": "汉", "聽": "听", "從": "从", "陸": "陆", "擬": "拟", "滿": "满", "繼": "继", "質": "质", "緊": "紧", "妝": "妆", "碼": "码", "辦": "办", "寧": "宁", "餚": "肴", "腸": "肠", "寫": "写", "約": "约", "頁": "页", "檢": "检", "鋪": "铺", "簷": "檐", "豐": "丰", "點": "点", "聶": "聂", "輛": "辆", "欖": "榄", "內": "内", "綴": "缀", "儀": "仪", "請": "请", "機": "机", "術": "术", "貴": "贵", "擾": "扰", "際": "际", "攤": "摊", "憶": "忆", "範": "范", "銷": "销", "蘆": "芦", "響": "响", "壇": "坛", "猶": "犹", "燙": "烫", "悅": "悦", "覺": "觉", "鍾": "钟", "證": "证", "繞": "绕", "傘": "伞", "紅": "红", "窯": "窑", "萵": "莴", "飯": "饭", "齋": "斋", "團": "团", "飪": "饪", "銀": "银", "賽": "赛", "覓": "觅", "該": "该", "營": "营", "計": "计", "聞": "闻", "鎢": "钨", "剛": "刚", "風": "风", "預": "预", "處": "处", "雙": "双", "蓮": "莲", "蔥": "葱", "裝": "装", "陳": "陈", "擔": "担", "適": "适", "轟": "轰", "錄": "录", "啞": "哑", "繚": "缭", "霧": "雾", "鈔": "钞", "議": "议", "壽": "寿", "雞": "鸡", "貨": "货", "間": "间", "貿": "贸", "寬": "宽", "窩": "窝", "揮": "挥", "講": "讲", "廈": "厦", "豬": "猪", "寵": "宠", "圖": "图", "棟": "栋", "稅": "税", "陣": "阵", "遺": "遗", "彈": "弹", "嚴": "严", "濟": "济", "溫": "温", "騎": "骑", "褲": "裤", "鑽": "钻", "聲": "声", "歡": "欢", "鶉": "鹑", "鹹": "咸", "進": "进", "勞": "劳", "陰": "阴", "樣": "样", "綿": "绵", "誼": "谊", "著": "着", "蘿": "萝", "簡": "简", "藝": "艺", "識": "识", "帶": "带", "齡": "龄", "娛": "娱", "錦": "锦", "財": "财", "狀": "状", "羶": "膻", "紐": "纽", "無": "无", "肅": "肃", "還": "还", "飽": "饱", "頸": "颈", "護": "护", "朧": "胧", "滷": "卤", "優": "优", "鹼": "碱", "紡": "纺", "種": "种", "鵝": "鹅", "蠅": "蝇", "穩": "稳", "說": "说", "説": "说", "線": "线", "擇": "择", "膩": "腻", "囪": "囱", "對": "对", "網": "网", "層": "层", "榮": "荣", "帥": "帅", "夠": "够", "領": "领", "則": "则", "紋": "纹", "醬": "酱", "參": "参", "宮": "宫", "雖": "虽", "據": "据", "幫": "帮", "臉": "脸", "懶": "懒", "閃": "闪", "茲": "兹", "減": "减", "棗": "枣", "譚": "谭", "餞": "饯", "濃": "浓", "協": "协", "嘆": "叹", "靜": "静", "夥": "伙", "髒": "脏", "鵑": "鹃", "謂": "谓", "頌": "颂", "釋": "释", "魷": "鱿", "醫": "医", "閉": "闭", "盡": "尽", "礦": "矿", "體": "体", "隨": "随", "尋": "寻", "務": "务", "鬱": "郁", "臘": "腊", "萬": "万", "鎖": "锁", "贊": "赞", "覽": "览", "櫻": "樱", "鏡": "镜", "餅": "饼", "細": "细", "愛": "爱", "爾": "尔", "饢": "馕", "寶": "宝", "籠": "笼", "讀": "读", "嬌": "娇", "維": "维", "鎮": "镇", "魚": "鱼", "鬧": "闹", "為": "为", "紗": "纱", "帳": "帐", "隊": "队", "戲": "戏", "獲": "获", "缽": "钵", "叢": "丛", "沒": "没", "駱": "骆", "湯": "汤", "許": "许", "號": "号", "冊": "册", "義": "义", "勸": "劝", "羣": "群", "壯": "壮", "凍": "冻", "雜": "杂", "課": "课", "槓": "杠", "棧": "栈", "產": "产", "搶": "抢", "疊": "叠", "黨": "党", "話": "话", "謝": "谢", "淨": "净", "願": "愿", "將": "将", "軌": "轨", "門": "门", "掛": "挂", "語": "语", "蟲": "虫", "豔": "艳", "頓": "顿", "懸": "悬", "歷": "历", "蹤": "踪", "縱": "纵", "脫": "脱", "潤": "润", "蘭": "兰", "貢": "贡", "嘗": "尝", "綜": "综", "荊": "荆", "籤": "签", "嗎": "吗", "徑": "径", "繪": "绘", "暫": "暂", "邏": "逻", "躍": "跃", "銳": "锐", "鋭": "锐", "納": "纳", "葷": "荤", "湧": "涌", "學": "学", "裏": "里", "儲": "储", "崍": "崃", "鈴": "铃", "劉": "刘", "鵪": "鹌", "況": "况", "吳": "吴", "針": "针", "彌": "弥", "鄧": "邓", "羅": "罗", "燉": "炖", "動": "动", "鹽": "盐", "駝": "驼", "廣": "广", "環": "环", "蟬": "蝉", "補": "补", "極": "极", "靈": "灵", "跡": "迹", "積": "积", "國": "国", "趙": "赵", "戰": "战", "劇": "剧", "塊": "块", "釣": "钓", "數": "数", "勝": "胜", "脈": "脉", "鷹": "鹰", "蓋": "盖", "驛": "驿", "鯊": "鲨", "顆": "颗", "膠": "胶", "鄰": "邻", "員": "员", "輕": "轻", "溼": "湿", "濕": "湿", "壓": "压", "邁": "迈", "棲": "栖", "異": "异", "縫": "缝", "僅": "仅", "順": "顺", "埡": "垭", "繹": "绎", "饞": "馋", "經": "经", "傷": "伤", "認": "认", "絲": "丝", "應": "应", "飲": "饮", "畝": "亩", "溝": "沟", "張": "张", "貼": "贴", "盧": "卢", "钂": "镋", "襪": "袜", "氳": "氲", "禪": "禅", "魯": "鲁", "銜": "衔", "紙": "纸", "薈": "荟", "費": "费", "壺": "壶", "涼": "凉", "軍": "军", "時": "时", "陽": "阳", "熗": "炝", "諸": "诸", "暢": "畅", "組": "组", "錫": "锡", "雲": "云", "謠": "谣", "啟": "启", "啓": "启", "鳴": "鸣", "頻": "频", "貝": "贝", "崗": "岗", "決": "决", "邊": "边", "棄": "弃", "廠": "厂", "漸": "渐", "牆": "墙", "視": "视", "給": "给", "買": "买", "户": "戶", "慮": "虑", "燻": "熏", "鴛": "鸳", "澤": "泽", "郵": "邮", "傳": "传", "聖": "圣", "蹺": "跷", "夢": "梦", "攜": "携", "難": "难", "貳": "贰", "瀾": "澜", "緒": "绪", "報": "报", "鴉": "鸦", "見": "见", "準": "准", "購": "购", "岡": "冈", "記": "记", "書": "书", "換": "换", "餘": "余", "紹": "绍", "淵": "渊", "輝": "辉", "峽": "峡", "譜": "谱", "絡": "络", "鳳": "凤", "觀": "观", "廝": "厮", "磚": "砖", "評": "评", "資": "资", "佔": "占", "題": "题", "剎": "刹", "龍": "龙", "擴": "扩", "燒": "烧", "燜": "焖", "離": "离", "湊": "凑", "縉": "缙", "鰱": "鲢", "鍋": "锅", "紀": "纪", "顧": "顾", "麼": "么", "筆": "笔", "興": "兴", "輩": "辈", "樸": "朴", "絕": "绝", "禮": "礼", "嶽": "岳", "匯": "汇", "採": "采", "長": "长", "訂": "订", "賦": "赋", "價": "价", "園": "园", "復": "复", "飛": "飞", "釐": "厘", "薔": "蔷", "級": "级", "隕": "陨", "撻": "挞", "鶴": "鹤", "構": "构", "現": "现", "鄉": "乡", "擼": "撸", "滾": "滚", "峯": "峰", "訪": "访", "親": "亲", "軸": "轴", "統": "统", "薦": "荐", "較": "较", "測": "测", "媽": "妈", "鑑": "鉴", "擠": "挤", "轉": "转", "遷": "迁", "東": "东", "錢": "钱", "曬": "晒", "設": "设", "須": "须", "兩": "两", "澆": "浇", "兒": "儿", "麥": "麦", "側": "侧", "燴": "烩", "漲": "涨", "會": "会", "閒": "闲", "櫃": "柜", "蕎": "荞", "職": "职", "屬": "属", "擋": "挡", "驗": "验", "騰": "腾", "陝": "陕", "醃": "腌", "龔": "龚", "鉑": "铂", "權": "权", "灩": "滟", "實": "实", "歸": "归", "釀": "酿", "檔": "档", "倉": "仓", "樓": "楼", "撲": "扑", "鱔": "鳝", "鴨": "鸭", "灣": "湾", "業": "业", "鳥": "鸟", "爛": "烂", "詳": "详", "濱": "滨", "單": "单", "舊": "旧", "揚": "扬", "瀉": "泻", "織": "织", "彎": "弯", "燈": "灯", "巔": "巅", "箏": "筝", "煙": "烟", "開": "开", "劃": "划", "么": "幺", "撈": "捞", "齊": "齐", "腦": "脑", "駕": "驾", "強": "强", "個": "个", "烏": "乌", "廂": "厢", "圍": "围", "橫": "横", "獎": "奖", "託": "托", "殞": "殒", "勁": "劲", "濁": "浊", "臨": "临", "筍": "笋", "虜": "虏", "漿": "浆", "賞": "赏", "晉": "晋", "養": "养", "擁": "拥", "腳": "脚", "訊": "讯", "島": "岛", "賃": "赁", "奧": "奥", "攝": "摄", "販": "贩", "廬": "庐", "發": "发", "築": "筑", "戶": "户", "縮": "缩", "顏": "颜", "魨": "鲀", "濤": "涛", "樹": "树", "鄒": "邹", "閱": "阅", "閲": "阅", "練": "练", "獨": "独", "賣": "卖", "欄": "栏", "萊": "莱", "終": "终", "險": "险", "蠍": "蝎", "創": "创", "薩": "萨", "並": "并", "與": "与", "馬": "马", "師": "师", "爐": "炉", "夾": "夹", "華": "华", "縣": "县", "嗆": "呛", "懷": "怀", "確": "确", "階": "阶", "卻": "却", "達": "达", "頂": "顶", "標": "标", "鮮": "鲜", "駐": "驻", "龐": "庞", "龜": "龟", "曉": "晓", "農": "农", "氣": "气", "藍": "蓝", "規": "规", "閣": "阁", "鷗": "鸥", "貫": "贯", "橋": "桥", "載": "载", "亂": "乱", "紉": "纫", "擺": "摆", "災": "灾", "這": "这", "蒼": "苍", "臥": "卧", "區": "区", "頭": "头", "樂": "乐", "銅": "铜", "駁": "驳", "繕": "缮", "總": "总", "變": "变", "項": "项", "廟": "庙", "節": "节", "結": "结", "艦": "舰", "類": "类", "鋼": "钢", "鍵": "键", "壩": "坝", "歲": "岁", "麗": "丽", "蝦": "虾", "鴦": "鸯", "備": "备", "漬": "渍", "談": "谈", "藥": "药", "連": "连", "電": "电", "隱": "隐", "顯": "显", "純": "纯", "續": "续", "俠": "侠", "誕": "诞", "調": "调", "餡": "馅", "鈀": "钯", "館": "馆", "鮑": "鲍", "問": "问", "凱": "凯", "餈": "糍", "賓": "宾", "蔣": "蒋", "掃": "扫", "訓": "训", "軒": "轩", "斷": "断", "綠": "绿", "遠": "远", "庫": "库", "貓": "猫", "錯": "错", "運": "运", "熱": "热", "條": "条", "瑪": "玛", "趕": "赶", "殺": "杀", "輯": "辑", "額": "额", "騾": "骡", "別": "别", "場": "场", "絨": "绒", "勢": "势", "稱": "称", "饊": "馓", "鐵": "铁", "過": "过", "卧": "臥", "鯨": "鲸", "鏈": "链", "賴": "赖", "態": "态", "韓": "韩", "專": "专", "巖": "岩", "衝": "冲", "飼": "饲", "畫": "画", "讓": "让", "軟": "软", "詩": "诗", "飾": "饰", "廳": "厅", "鯽": "鲫", "圓": "圆", "鬥": "斗", "導": "导", "鯉": "鲤", "慶": "庆", "灘": "滩", "莊": "庄", "眾": "众", "車": "车", "漁": "渔", "詢": "询", "温": "溫", "葉": "叶", "摻": "掺", "獅": "狮", "槳": "桨", "粵": "粤", "飄": "飘", "窮": "穷", "編": "编", "黃": "黄", "鷺": "鹭", "躥": "蹿", "亞": "亚", "輪": "轮", "兇": "凶", "聯": "联", "盤": "盘", "瘋": "疯", "韻": "韵", "楊": "杨", "來": "来", "蘇": "苏", "幹": "干", "滄": "沧", "幾": "几", "塗": "涂", "恆": "恒", "負": "负", "論": "论", "鰍": "鳅", "選": "选", "當": "当", "嶺": "岭", "艙": "舱", "頗": "颇", "試": "试", "櫚": "榈", "譽": "誉", "廚": "厨", "蔭": "荫", "樞": "枢", "闊": "阔", "餃": "饺", "膽": "胆", "聰": "聪", "註": "注", "鐘": "钟", "菸": "烟", "誌": "志", "週": "周", "緣": "缘", "闆": "板", "製": "制", "迴": "回", "鱂": "鳉", "糰": "团", "儘": "尽", "禦": "御", "盪": "荡", "蹟": "迹", "驚": "惊", "畢": "毕", "併": "并", "蔔": "卜", "鬆": "松", "紮": "扎", "係": "系", "垻": "坝", "捨": "舍", "複": "复", "罈": "坛", "孃": "娘", "穀": "谷", "緻": "致", "韆": "千", "臟": "脏", "薑": "姜", "檯": "台", "鞦": "秋", "輸": "输"};
