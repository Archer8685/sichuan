...
const T2S = {"麵": "面", "裡": "里", "遊": "游", "隻": "只", "乾": "干", "後": "后", "髮": "发", "於": "于", "臺": "台", "嚐": "尝", "綜": "综", "記": "记", "維": "维", "豔": "艳", "餡": "馅", "髒": "脏", "勸": "劝", "員": "员", "燉": "炖", "氳": "氲", "設": "设", "兇": "凶", "錦": "锦", "筍": "笋", "帶": "带", "鄒": "邹", "軍": "军", "鍋": "锅", "陣": "阵", "漬": "渍", "調": "调", "馬": "马", "濁": "浊", "縉": "缙", "煙": "烟", "別": "别", "統": "统", "鹽": "盐", "團": "团", "鴨": "鸭", "園": "园", "較": "较", "幫": "帮", "濟": "济", "範": "范", "帥": "帅", "陽": "阳", "養": "养", "茲": "兹", "恆": "恒", "輝": "辉", "釋": "释", "圖": "图", "埡": "垭", "鯉": "鲤", "黃": "黄", "復": "复", "機": "机", "棧": "栈", "遷": "迁", "廬": "庐", "隨": "随", "蔣": "蒋", "創": "创", "強": "强", "營": "营", "夢": "梦", "願": "愿", "龐": "庞", "覺": "觉", "結": "结", "歷": "历", "躍": "跃", "餘": "余", "膩": "腻", "褲": "裤", "議": "议", "壇": "坛", "壩": "坝", "聯": "联", "粵": "粤", "劇": "剧", "舊": "旧", "澆": "浇", "飾": "饰", "裏": "里", "擼": "撸", "魯": "鲁", "钂": "镋", "職": "职", "價": "价", "剛": "刚", "勢": "势", "攜": "携", "紙": "纸", "劉": "刘", "贊": "赞", "濱": "滨", "瘋": "疯", "視": "视", "貼": "贴", "參": "参", "飲": "饮", "悅": "悦", "關": "关", "鮑": "鲍", "燴": "烩", "羅": "罗", "遺": "遗", "決": "决", "聽": "听", "豐": "丰", "輯": "辑", "覓": "觅", "愛": "爱", "農": "农", "顧": "顾", "補": "补", "還": "还", "彈": "弹", "轟": "轰", "歡": "欢", "亞": "亚", "蓋": "盖", "擋": "挡", "衝": "冲", "欄": "栏", "鮮": "鲜", "圍": "围", "屬": "属", "漁": "渔", "稅": "税", "蹺": "跷", "當": "当", "鋪": "铺", "閱": "阅", "閲": "阅", "講": "讲", "縫": "缝", "鷹": "鹰", "納": "纳", "稱": "称", "勞": "劳", "棲": "栖", "賀": "贺", "鬧": "闹", "縣": "县", "寶": "宝", "卧": "臥", "寵": "宠", "幹": "干", "繞": "绕", "燻": "熏", "兒": "儿", "歸": "归", "雜": "杂", "計": "计", "荊": "荆", "壺": "壶", "築": "筑", "蒼": "苍", "斷": "断", "濃": "浓", "櫚": "榈", "續": "续", "鎮": "镇", "懸": "悬", "輕": "轻", "驗": "验", "飯": "饭", "聖": "圣", "領": "领", "貢": "贡", "簷": "檐", "開": "开", "樞": "枢", "媽": "妈", "彌": "弥", "鴦": "鸯", "勝": "胜", "師": "师", "藝": "艺", "蓮": "莲", "槳": "桨", "燜": "焖", "紡": "纺", "實": "实", "錫": "锡", "經": "经", "鯨": "鲸", "藍": "蓝", "導": "导", "飽": "饱", "總": "总", "揮": "挥", "買": "买", "蹤": "踪", "帳": "帐", "貓": "猫", "純": "纯", "膠": "胶", "論": "论", "釣": "钓", "變": "变", "漲": "涨", "龜": "龟", "頗": "颇", "賓": "宾", "著": "着", "腳": "脚", "網": "网", "顏": "颜", "鏡": "镜", "採": "采", "僅": "仅", "朧": "胧", "摻": "掺", "優": "优", "協": "协", "攝": "摄", "庫": "库", "賴": "赖", "務": "务", "聲": "声", "氣": "气", "簡": "简", "檔": "档", "脫": "脱", "輪": "轮", "輛": "辆", "灘": "滩", "廳": "厅", "軌": "轨", "讀": "读", "灣": "湾", "臘": "腊", "廂": "厢", "銳": "锐", "鋭": "锐", "魷": "鱿", "擴": "扩", "聞": "闻", "邊": "边", "醃": "腌", "冊": "册", "層": "层", "橫": "横", "現": "现", "離": "离", "樓": "楼", "掛": "挂", "麥": "麦", "俠": "侠", "謠": "谣", "輩": "辈", "親": "亲", "薈": "荟", "側": "侧", "壯": "壮", "鵑": "鹃", "產": "产", "崗": "岗", "報": "报", "連": "连", "鬱": "郁", "廝": "厮", "廚": "厨", "達": "达", "鵝": "鹅", "編": "编", "壓": "压", "賦": "赋", "環": "环", "銀": "银", "滄": "沧", "廣": "广", "響": "响", "絡": "络", "麗": "丽", "給": "给", "揚": "扬", "圓": "圆", "鍾": "钟", "腸": "肠", "級": "级", "嘗": "尝", "質": "质", "託": "托", "盧": "卢", "況": "况", "額": "额", "蟬": "蝉", "鷺": "鹭", "卻": "却", "郵": "邮", "為": "为", "練": "练", "構": "构", "户": "戶", "臥": "卧", "誼": "谊", "温": "溫", "災": "灾", "鹼": "碱", "廈": "厦", "單": "单", "奧": "奥", "訂": "订", "錄": "录", "霧": "雾", "鳴": "鸣", "磚": "砖", "夾": "夹", "齡": "龄", "門": "门", "轉": "转", "賽": "赛", "資": "资", "節": "节", "術": "术", "讓": "让", "賞": "赏", "騰": "腾", "話": "话", "繹": "绎", "駐": "驻", "夥": "伙", "錯": "错", "詢": "询", "爛": "烂", "鑑": "鉴", "剎": "刹", "嘆": "叹", "鳳": "凤", "嶺": "岭", "過": "过", "蔥": "葱", "隕": "陨", "頌": "颂", "淵": "渊", "縱": "纵", "鯽": "鲫", "與": "与", "紀": "纪", "駁": "驳", "凱": "凯", "兩": "两", "滿": "满", "絲": "丝", "涼": "凉", "問": "问", "國": "国", "將": "将", "槓": "杠", "澤": "泽", "陝": "陕", "車": "车", "佔": "占", "峽": "峡", "爾": "尔", "負": "负", "織": "织", "嗎": "吗", "鄉": "乡", "異": "异", "慮": "虑", "萵": "莴", "綠": "绿", "獅": "狮", "窮": "穷", "畫": "画", "撈": "捞", "體": "体", "權": "权", "擬": "拟", "臨": "临", "鏈": "链", "穩": "稳", "曬": "晒", "夠": "够", "萬": "万", "謝": "谢", "餅": "饼", "豬": "猪", "繼": "继", "缽": "钵", "禮": "礼", "薦": "荐", "塊": "块", "顆": "颗", "譽": "誉", "縮": "缩", "頁": "页", "幾": "几", "擔": "担", "雙": "双", "畝": "亩", "訪": "访", "沒": "没", "試": "试", "漸": "渐", "劃": "划", "遠": "远", "語": "语", "滾": "滚", "軒": "轩", "醫": "医", "欖": "榄", "熗": "炝", "繕": "缮", "燙": "烫", "覽": "览", "銅": "铜", "雞": "鸡", "書": "书", "戰": "战", "動": "动", "類": "类", "懷": "怀", "聶": "聂", "賣": "卖", "儀": "仪", "徑": "径", "諸": "诸", "細": "细", "櫻": "樱", "數": "数", "爐": "炉", "錢": "钱", "擺": "摆", "項": "项", "樂": "乐", "傳": "传", "萊": "莱", "邁": "迈", "憶": "忆", "專": "专", "題": "题", "撻": "挞", "搶": "抢", "湧": "涌", "儲": "储", "漢": "汉", "貨": "货", "靜": "静", "電": "电", "並": "并", "灩": "滟", "個": "个", "戲": "戏", "蔭": "荫", "蕎": "荞", "鴛": "鸳", "熱": "热", "請": "请", "櫃": "柜", "獨": "独", "鎖": "锁", "辦": "办", "會": "会", "歲": "岁", "鰱": "鲢", "鶉": "鹑", "湯": "汤", "壽": "寿", "預": "预", "內": "内", "義": "义", "擁": "拥", "東": "东", "絨": "绒", "騾": "骡", "順": "顺", "蘿": "萝", "箏": "筝", "購": "购", "曉": "晓", "疊": "叠", "紉": "纫", "絕": "绝", "釀": "酿", "藥": "药", "窩": "窝", "寬": "宽", "筆": "笔", "約": "约", "財": "财", "巖": "岩", "間": "间", "暫": "暂", "獎": "奖", "攤": "摊", "么": "幺", "雲": "云", "薩": "萨", "醬": "酱", "貴": "贵", "鬥": "斗", "饞": "馋", "飄": "飘", "鑽": "钻", "湊": "凑", "傷": "伤", "吳": "吴", "鴉": "鸦", "齊": "齐", "寧": "宁", "島": "岛", "凍": "冻", "線": "线", "娛": "娱", "寫": "写", "瀉": "泻", "狀": "状", "尋": "寻", "葷": "荤", "巔": "巅", "標": "标", "鶴": "鹤", "淨": "净", "擾": "扰", "鰍": "鳅", "蟲": "虫", "蠅": "蝇", "臉": "脸", "載": "载", "費": "费", "對": "对", "鄧": "邓", "說": "说", "説": "说", "鵪": "鹌", "驛": "驿", "鱔": "鳝", "閣": "阁", "嗆": "呛", "樸": "朴", "減": "减", "鉑": "铂", "滷": "卤", "極": "极", "餈": "糍", "際": "际", "頸": "颈", "規": "规", "業": "业", "販": "贩", "脈": "脉", "誕": "诞", "窯": "窑", "興": "兴", "魨": "鲀", "蘭": "兰", "謂": "谓", "適": "适", "緒": "绪", "針": "针", "閉": "闭", "趕": "赶", "棗": "枣", "雖": "虽", "賃": "赁", "緊": "紧", "險": "险", "裝": "装", "貫": "贯", "獲": "获", "須": "须", "訓": "训", "綿": "绵", "塗": "涂", "啟": "启", "啓": "启", "隱": "隐", "蝦": "虾", "階": "阶", "艙": "舱", "繚": "缭", "鈔": "钞", "宮": "宫", "鈀": "钯", "鄰": "邻", "認": "认", "溫": "温", "繪": "绘", "葉": "叶", "鷗": "鸥", "隊": "队", "莊": "庄", "組": "组", "積": "积", "點": "点", "籤": "签", "識": "识", "銜": "衔", "區": "区", "處": "处", "盡": "尽", "發": "发", "閒": "闲", "則": "则", "魚": "鱼", "蘆": "芦", "廟": "庙", "嶽": "岳", "應": "应", "頭": "头", "飼": "饲", "烏": "乌", "軸": "轴", "換": "换", "從": "从", "檢": "检", "邏": "逻", "貝": "贝", "風": "风", "選": "选", "號": "号", "見": "见", "瀾": "澜", "長": "长", "楊": "杨", "妝": "妆", "鐵": "铁", "紐": "纽", "時": "时", "龔": "龚", "饢": "馕", "釐": "厘", "靈": "灵", "饊": "馓", "課": "课", "終": "终", "眾": "众", "頂": "顶", "餵": "喂", "趙": "赵", "慶": "庆", "籠": "笼", "戶": "户", "談": "谈", "準": "准", "岡": "冈", "該": "该", "樣": "样", "峯": "峰", "難": "难", "闊": "阔", "種": "种", "飛": "飞", "漿": "浆", "齋": "斋", "場": "场", "黨": "党", "礦": "矿", "無": "无", "薔": "蔷", "虜": "虏", "牆": "墙", "棟": "栋", "紋": "纹", "囪": "囱", "顯": "显", "暢": "畅", "擇": "择", "詳": "详", "啞": "哑", "據": "据", "匯": "汇", "閃": "闪", "貳": "贰", "備": "备", "麼": "么", "紅": "红", "潤": "润", "燒": "烧", "擠": "挤", "鎢": "钨", "許": "许", "這": "这", "晉": "晋", "餃": "饺", "頓": "顿", "學": "学", "頻": "频", "彎": "弯", "廠": "厂", "跡": "迹", "進": "进", "勁": "劲", "鯊": "鲨", "溼": "湿", "濕": "湿", "紹": "绍", "飪": "饪", "崍": "崃", "躥": "蹿", "盤": "盘", "嚴": "严", "軟": "软", "韻": "韵", "條": "条", "蘇": "苏", "騎": "骑", "餞": "饯", "碼": "码", "腦": "脑", "駱": "骆", "樹": "树", "鳥": "鸟", "詩": "诗", "韓": "韩", "叢": "丛", "紗": "纱", "銷": "销", "張": "张", "陰": "阴", "溝": "沟", "殺": "杀", "燈": "灯", "龍": "龙", "羣": "群", "運": "运", "華": "华", "掃": "扫", "證": "证", "禪": "禅", "襪": "袜", "蠍": "蝎", "傘": "伞", "陳": "陈", "評": "评", "貿": "贸", "駕": "驾", "護": "护", "亂": "乱", "譚": "谭", "觀": "观", "艦": "舰", "鋼": "钢", "訊": "讯", "羶": "膻", "猶": "犹", "榮": "荣", "測": "测", "確": "确", "橋": "桥", "鹹": "咸", "濤": "涛", "態": "态", "來": "来", "譜": "谱", "殞": "殒", "瑪": "玛", "倉": "仓", "陸": "陆", "懶": "懒", "撲": "扑", "館": "馆", "棄": "弃", "鍵": "键", "盪": "荡", "蹟": "迹", "鐘": "钟", "捨": "舍", "輸": "输", "複": "复", "禦": "御", "週": "周", "蔔": "卜", "鞦": "秋", "膽": "胆", "聰": "聪", "紮": "扎", "緣": "缘", "併": "并", "係": "系", "菸": "烟", "罈": "坛", "檯": "台", "垻": "坝", "孃": "娘", "鬆": "松", "誌": "志", "迴": "回", "薑": "姜", "緻": "致", "畢": "毕", "糰": "团", "儘": "尽", "註": "注", "臟": "脏", "穀": "谷", "韆": "千", "驚": "惊", "鱂": "鳉", "製": "制", "闆": "板"};
