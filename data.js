const PLACES = [
 ...
 },
 {
  ...
  "notes": "兔頭為兔肉無豬；注意冒血旺可能為豬血（點前確認，可選鴨血）、滷味櫃豬蹄類避開。總店在雙流，距離市中心較遠，建議作為專程備選。",
  "city": "成都"
 },
 {
  "name": "廖老媽蹄花（人民公園總店）",
 ...
 },
 {
  ...
  "category": "午晚餐",
  "halal": false,
  "cuisine": "高端海鮮自助（帝王蟹/波龍/刺身）",
  "area": "錦江區·成都IFS",
  "address": "成都市錦江區紅星路三段1號成都IFS購物中心L5層L505號",
  "lat": 30.6529,
  "lng": 104.081,
  "hours": "商場營業10:00-22:00；工作日晚宴18:00-21:00，周末及節假日晚宴17:00-19:30／19:40-22:00",
  "price": "以預訂場次為準",
  "rating": null,
  "rating_source": null,
  "dishes": [
  ...
  "reason": "位於成都IFS五樓的黑金主題高端海鮮自助，逛完太古里與IFS可直接用餐。",
  "notes": "⚠️ 建議提前1-2天預約並確認晚宴場次；海鮮為主但自助區有含豬肉熱菜與混合製作區，非清真，取餐前請確認；成都IFS官網門店L505，電話19381920888。"
 },
 {
...
const T2S = {"麵": "面", "裡": "里", "遊": "游", "隻": "只", "乾": "干", "後": "后", "髮": "发", "於": "于", "臺": "台", "嚐": "尝", "蒼": "苍", "鳥": "鸟", "鎢": "钨", "亞": "亚", "賞": "赏", "嘗": "尝", "認": "认", "燴": "烩", "導": "导", "揮": "挥", "夠": "够", "書": "书", "採": "采", "飛": "飞", "釀": "酿", "擼": "撸", "銅": "铜", "繹": "绎", "葉": "叶", "薩": "萨", "災": "灾", "温": "溫", "斷": "断", "掛": "挂", "脈": "脉", "虜": "虏", "羶": "膻", "優": "优", "叢": "丛", "揚": "扬", "領": "领", "覓": "觅", "廚": "厨", "卧": "臥", "妝": "妆", "夥": "伙", "鏈": "链", "區": "区", "頻": "频", "麗": "丽", "終": "终", "將": "将", "買": "买", "邁": "迈", "蔣": "蒋", "則": "则", "棟": "栋", "凍": "冻", "鹽": "盐", "聯": "联", "聽": "听", "島": "岛", "鍾": "钟", "隱": "隐", "會": "会", "鄒": "邹", "漁": "渔", "槳": "桨", "燻": "熏", "鯊": "鲨", "鯉": "鲤", "計": "计", "齊": "齐", "識": "识", "額": "额", "艦": "舰", "燈": "灯", "脫": "脱", "願": "愿", "淵": "渊", "國": "国", "萬": "万", "蹤": "踪", "陰": "阴", "戰": "战", "賣": "卖", "況": "况", "贊": "赞", "窩": "窝", "貨": "货", "蓮": "莲", "顏": "颜", "縣": "县", "熗": "炝", "綴": "缀", "設": "设", "滄": "沧", "購": "购", "磚": "砖", "價": "价", "帥": "帅", "鄉": "乡", "長": "长", "託": "托", "騾": "骡", "標": "标", "隨": "随", "鹹": "咸", "沒": "没", "貫": "贯", "動": "动", "趕": "赶", "駕": "驾", "飾": "饰", "觀": "观", "續": "续", "騰": "腾", "雲": "云", "燙": "烫", "獲": "获", "銜": "衔", "負": "负", "賃": "赁", "俠": "侠", "缽": "钵", "閃": "闪", "輯": "辑", "緊": "紧", "漬": "渍", "畫": "画", "橋": "桥", "線": "线", "兩": "两", "躍": "跃", "簷": "檐", "電": "电", "醃": "腌", "鉑": "铂", "誼": "谊", "藥": "药", "楊": "杨", "餡": "馅", "擠": "挤", "夾": "夹", "範": "范", "灩": "滟", "聖": "圣", "繕": "缮", "軟": "软", "劉": "刘", "鎮": "镇", "擁": "拥", "隊": "队", "課": "课", "點": "点", "峽": "峡", "補": "补", "擺": "摆", "備": "备", "廟": "庙", "黨": "党", "階": "阶", "貳": "贰", "錢": "钱", "繚": "缭", "壇": "坛", "瀾": "澜", "肅": "肃", "潤": "润", "馬": "马", "給": "给", "鑽": "钻", "實": "实", "臨": "临", "鴛": "鸳", "穩": "稳", "靈": "灵", "彎": "弯", "礦": "矿", "細": "细", "際": "际", "歷": "历", "個": "个", "鮮": "鲜", "陸": "陆", "鷺": "鹭", "頭": "头", "尋": "寻", "師": "师", "號": "号", "詢": "询", "異": "异", "壽": "寿", "壩": "坝", "題": "题", "團": "团", "質": "质", "顆": "颗", "輛": "辆", "態": "态", "蘿": "萝", "濟": "济", "嗎": "吗", "蕎": "荞", "燒": "烧", "齋": "斋", "娛": "娱", "風": "风", "陳": "陈", "漢": "汉", "廬": "庐", "粵": "粤", "臉": "脸", "檢": "检", "歸": "归", "繪": "绘", "見": "见", "啟": "启", "啓": "启", "繼": "继", "宮": "宫", "飪": "饪", "撲": "扑", "詳": "详", "縉": "缙", "務": "务", "鵝": "鹅", "樣": "样", "進": "进", "寶": "宝", "劃": "划", "藍": "蓝", "寵": "宠", "參": "参", "約": "约", "織": "织", "護": "护", "訓": "训", "萵": "莴", "塗": "涂", "顯": "显", "鎖": "锁", "髒": "脏", "櫃": "柜", "澆": "浇", "裏": "里", "達": "达", "蓋": "盖", "牆": "墙", "巔": "巅", "創": "创", "劇": "剧", "朧": "胧", "側": "侧", "飄": "飘", "鳴": "鸣", "興": "兴", "綠": "绿", "鑑": "鉴", "腦": "脑", "陣": "阵", "羣": "群", "嗆": "呛", "餅": "饼", "屬": "属", "熱": "热", "黃": "黄", "氳": "氲", "這": "这", "總": "总", "處": "处", "縮": "缩", "鯽": "鲫", "濃": "浓", "廳": "厅", "親": "亲", "銳": "锐", "鋭": "锐", "廝": "厮", "絲": "丝", "經": "经", "獨": "独", "魯": "鲁", "單": "单", "棧": "栈", "夢": "梦", "漿": "浆", "塊": "块", "臘": "腊", "餞": "饯", "節": "节", "奧": "奥", "針": "针", "發": "发", "欄": "栏", "驛": "驿", "組": "组", "鍵": "键", "盤": "盘", "萊": "莱", "樸": "朴", "溝": "沟", "練": "练", "憶": "忆", "豬": "猪", "項": "项", "驗": "验", "築": "筑", "盡": "尽", "櫚": "榈", "許": "许", "內": "内", "談": "谈", "烏": "乌", "積": "积", "輕": "轻", "論": "论", "鬧": "闹", "韓": "韩", "諸": "诸", "壓": "压", "譚": "谭", "鐵": "铁", "湯": "汤", "閣": "阁", "級": "级", "確": "确", "險": "险", "魨": "鲀", "從": "从", "鈔": "钞", "頂": "顶", "擋": "挡", "據": "据", "腳": "脚", "寬": "宽", "數": "数", "佔": "占", "燜": "焖", "餈": "糍", "覺": "觉", "飲": "饮", "擴": "扩", "類": "类", "盧": "卢", "櫻": "樱", "畝": "亩", "環": "环", "講": "讲", "圓": "圆", "匯": "汇", "獎": "奖", "鰍": "鳅", "鷹": "鹰", "殺": "杀", "鄰": "邻", "體": "体", "張": "张", "濱": "滨", "恆": "恒", "軸": "轴", "涼": "凉", "貢": "贡", "儀": "仪", "讓": "让", "么": "幺", "該": "该", "禪": "禅", "臥": "卧", "鵑": "鹃", "狀": "状", "適": "适", "漲": "涨", "帶": "带", "懸": "悬", "廣": "广", "還": "还", "證": "证", "間": "间", "戶": "户", "絨": "绒", "納": "纳", "讀": "读", "戲": "戏", "員": "员", "園": "园", "復": "复", "閒": "闲", "術": "术", "筍": "笋", "陝": "陕", "樓": "楼", "維": "维", "純": "纯", "霧": "雾", "紡": "纺", "蟲": "虫", "預": "预", "賦": "赋", "頁": "页", "絕": "绝", "緒": "绪", "車": "车", "協": "协", "繞": "绕", "鹼": "碱", "頓": "顿", "測": "测", "銀": "银", "鵪": "鹌", "暫": "暂", "擾": "扰", "稱": "称", "擇": "择", "軒": "轩", "館": "馆", "條": "条", "聞": "闻", "東": "东", "幾": "几", "庫": "库", "瑪": "玛", "攜": "携", "崍": "崃", "輩": "辈", "濁": "浊", "遷": "迁", "駐": "驻", "餵": "喂", "須": "须", "殞": "殒", "對": "对", "棲": "栖", "駝": "驼", "應": "应", "賴": "赖", "廠": "厂", "門": "门", "無": "无", "僅": "仅", "灣": "湾", "爾": "尔", "曉": "晓", "饊": "馓", "飽": "饱", "難": "难", "勞": "劳", "運": "运", "澤": "泽", "銷": "销", "與": "与", "寫": "写", "吳": "吴", "紹": "绍", "鮑": "鲍", "葷": "荤", "搶": "抢", "荊": "荆", "蟬": "蝉", "羅": "罗", "摻": "掺", "紋": "纹", "媽": "妈", "陽": "阳", "統": "统", "釣": "钓", "蔥": "葱", "瀉": "泻", "農": "农", "啞": "哑", "掃": "扫", "產": "产", "龔": "龚", "貼": "贴", "結": "结", "爐": "炉", "麼": "么", "鄧": "邓", "輝": "辉", "慶": "庆", "裝": "装", "紐": "纽", "養": "养", "淨": "净", "兇": "凶", "攝": "摄", "蝦": "虾", "崗": "岗", "聲": "声", "湧": "涌", "當": "当", "謝": "谢", "饞": "馋", "曬": "晒", "煙": "烟", "簡": "简", "醬": "酱", "溼": "湿", "濕": "湿", "巖": "岩", "剎": "刹", "彌": "弥", "離": "离", "燉": "炖", "軌": "轨", "嚴": "严", "剛": "刚", "儲": "储", "譽": "誉", "極": "极", "暢": "畅", "轟": "轰", "户": "戶", "慮": "虑", "幫": "帮", "餘": "余", "邏": "逻", "現": "现", "龐": "庞", "業": "业", "碼": "码", "勸": "劝", "開": "开", "較": "较", "謠": "谣", "紅": "红", "冊": "册", "時": "时", "卻": "却", "為": "为", "視": "视", "貝": "贝", "種": "种", "圍": "围", "語": "语", "豔": "艳", "編": "编", "蔭": "荫", "籠": "笼", "齡": "龄", "氣": "气", "駁": "驳", "钂": "镋", "鴉": "鸦", "蠍": "蝎", "變": "变", "滿": "满", "籤": "签", "蘆": "芦", "顧": "顾", "職": "职", "駱": "骆", "鋪": "铺", "廈": "厦", "稅": "税", "茲": "兹", "帳": "帐", "縫": "缝", "問": "问", "濤": "涛", "鈴": "铃", "壯": "壮", "輪": "轮", "貴": "贵", "魷": "鱿", "賽": "赛", "選": "选", "莊": "庄", "營": "营", "衝": "冲", "義": "义", "決": "决", "欖": "榄", "凱": "凯", "愛": "爱", "趙": "赵", "靜": "静", "學": "学", "勢": "势", "專": "专", "訂": "订", "榮": "荣", "窮": "穷", "岡": "冈", "報": "报", "鬱": "郁", "強": "强", "鬥": "斗", "麥": "麦", "貿": "贸", "漸": "渐", "準": "准", "鏡": "镜", "蠅": "蝇", "棗": "枣", "傳": "传", "攤": "摊", "誕": "诞", "頌": "颂", "歡": "欢", "譜": "谱", "釐": "厘", "膩": "腻", "減": "减", "猶": "犹", "賀": "贺", "費": "费", "紀": "纪", "藝": "艺", "閱": "阅", "閲": "阅", "訪": "访", "層": "层", "艙": "舱", "雜": "杂", "記": "记", "躥": "蹿", "雙": "双", "錦": "锦", "滷": "卤", "寧": "宁", "騎": "骑", "傘": "伞", "檔": "档", "販": "贩", "請": "请", "財": "财", "鴨": "鸭", "饢": "馕", "亂": "乱", "訊": "讯", "埡": "垭", "遺": "遗", "眾": "众", "話": "话", "遠": "远", "鍋": "锅", "調": "调", "樞": "枢", "撈": "捞", "溫": "温", "嶺": "岭", "換": "换", "權": "权", "關": "关", "腸": "肠", "飼": "饲", "閉": "闭", "傷": "伤", "褲": "裤", "錫": "锡", "圖": "图", "擬": "拟", "飯": "饭", "壺": "壶", "峯": "峰", "貓": "猫", "鳳": "凤", "網": "网", "舊": "旧", "彈": "弹", "別": "别", "辦": "办", "跡": "迹", "龍": "龙", "勝": "胜", "筆": "笔", "棄": "弃", "樂": "乐", "疊": "叠", "鈀": "钯", "蘇": "苏", "規": "规", "囪": "囱", "並": "并", "詩": "诗", "瘋": "疯", "連": "连", "頗": "颇", "聶": "聂", "試": "试", "窯": "窑", "嘆": "叹", "隕": "陨", "響": "响", "機": "机", "膠": "胶", "悅": "悦", "絡": "络", "雞": "鸡", "豐": "丰", "嶽": "岳", "禮": "礼", "載": "载", "龜": "龟", "蘭": "兰", "槓": "杠", "著": "着", "兒": "儿", "樹": "树", "鰱": "鲢", "來": "来", "軍": "军", "襪": "袜", "邊": "边", "紙": "纸", "徑": "径", "議": "议", "歲": "岁", "倉": "仓", "場": "场", "懷": "怀", "鱔": "鳝", "灘": "滩", "鶴": "鹤", "綿": "绵", "蹺": "跷", "滾": "滚", "鯨": "鲸", "構": "构", "橫": "横", "撻": "挞", "獅": "狮", "雖": "虽", "賓": "宾", "錯": "错", "資": "资", "鴦": "鸯", "薈": "荟", "覽": "览", "幹": "干", "湊": "凑", "謂": "谓", "廂": "厢", "順": "顺", "頸": "颈", "擔": "担", "薦": "荐", "晉": "晋", "嬌": "娇", "勁": "劲", "薔": "蔷", "縱": "纵", "鋼": "钢", "闊": "阔", "錄": "录", "說": "说", "説": "说", "醫": "医", "綜": "综", "餃": "饺", "魚": "鱼", "懶": "懒", "紗": "纱", "釋": "释", "箏": "筝", "韻": "韵", "郵": "邮", "華": "华", "爛": "烂", "鷗": "鸥", "評": "评", "轉": "转", "鶉": "鹑", "過": "过", "紉": "纫", "捨": "舍", "鐘": "钟", "迴": "回", "鬆": "松", "檯": "台", "紮": "扎", "臟": "脏", "膽": "胆", "複": "复", "穀": "谷", "禦": "御", "畢": "毕", "製": "制", "註": "注", "併": "并", "蹟": "迹", "誌": "志", "驚": "惊", "鞦": "秋", "儘": "尽", "闆": "板", "聰": "聪", "孃": "娘", "緣": "缘", "盪": "荡", "韆": "千", "係": "系", "輸": "输", "緻": "致", "薑": "姜", "鱂": "鳉", "週": "周", "菸": "烟", "蔔": "卜", "糰": "团", "罈": "坛", "垻": "坝"};
