const PLACES = [
 ...
 },
 {
  ...
  "price": "約68元/人",
  "rating": null,
  "rating_source": "品牌100網（口味/環境/服務8.9/10）",
  "dishes": [
   "新疆椒麻雞",
   "烤羊肉串",
   "手抓飯",
...
const T2S = {"麵": "面", "裡": "里", "遊": "游", "隻": "只", "乾": "干", "後": "后", "髮": "发", "於": "于", "臺": "台", "嚐": "尝", "廚": "厨", "職": "职", "綴": "缀", "么": "幺", "參": "参", "說": "说", "説": "说", "勝": "胜", "編": "编", "剎": "刹", "壯": "壮", "獨": "独", "饢": "馕", "鉑": "铂", "湯": "汤", "這": "这", "貴": "贵", "勁": "劲", "際": "际", "鮑": "鲍", "項": "项", "見": "见", "試": "试", "裝": "装", "愛": "爱", "餅": "饼", "駁": "驳", "缽": "钵", "覺": "觉", "給": "给", "餈": "糍", "吳": "吴", "臘": "腊", "澆": "浇", "傘": "伞", "鰱": "鲢", "鷗": "鸥", "災": "灾", "峯": "峰", "頻": "频", "節": "节", "縣": "县", "記": "记", "頌": "颂", "訓": "训", "雲": "云", "慮": "虑", "鷹": "鹰", "邊": "边", "學": "学", "掃": "扫", "擠": "挤", "設": "设", "蘆": "芦", "揮": "挥", "邏": "逻", "灩": "滟", "屬": "属", "駕": "驾", "將": "将", "嶺": "岭", "無": "无", "難": "难", "峽": "峡", "雙": "双", "圍": "围", "狀": "状", "湧": "涌", "顯": "显", "壇": "坛", "鑑": "鉴", "獅": "狮", "郵": "邮", "頂": "顶", "龐": "庞", "貝": "贝", "蔣": "蒋", "鬥": "斗", "囪": "囱", "礦": "矿", "肅": "肃", "幫": "帮", "聞": "闻", "龔": "龚", "圖": "图", "搶": "抢", "鈔": "钞", "發": "发", "淵": "渊", "紉": "纫", "駐": "驻", "閉": "闭", "跡": "迹", "溝": "沟", "載": "载", "區": "区", "時": "时", "檔": "档", "數": "数", "響": "响", "義": "义", "針": "针", "羅": "罗", "漁": "渔", "嶽": "岳", "講": "讲", "撻": "挞", "啞": "哑", "來": "来", "磚": "砖", "壩": "坝", "與": "与", "溫": "温", "陽": "阳", "鯉": "鲤", "鍋": "锅", "麼": "么", "標": "标", "葉": "叶", "魯": "鲁", "劉": "刘", "嗆": "呛", "補": "补", "過": "过", "漬": "渍", "換": "换", "賣": "卖", "機": "机", "擔": "担", "邁": "迈", "魨": "鲀", "擬": "拟", "優": "优", "階": "阶", "聯": "联", "輕": "轻", "談": "谈", "關": "关", "豔": "艳", "衝": "冲", "廟": "庙", "勞": "劳", "據": "据", "湊": "凑", "環": "环", "興": "兴", "醫": "医", "問": "问", "領": "领", "養": "养", "擺": "摆", "橫": "横", "驗": "验", "饞": "馋", "龍": "龙", "銀": "银", "釐": "厘", "钂": "镋", "戰": "战", "濟": "济", "錢": "钱", "擼": "撸", "應": "应", "棟": "栋", "徑": "径", "達": "达", "銅": "铜", "覓": "觅", "質": "质", "塊": "块", "歡": "欢", "齊": "齐", "脫": "脱", "務": "务", "銷": "销", "兇": "凶", "龜": "龟", "鶉": "鹑", "熱": "热", "議": "议", "顧": "顾", "護": "护", "莊": "庄", "奧": "奥", "轉": "转", "綠": "绿", "淨": "净", "巖": "岩", "筍": "笋", "宮": "宫", "誕": "诞", "蟬": "蝉", "撲": "扑", "訊": "讯", "粵": "粤", "飽": "饱", "燜": "焖", "嚴": "严", "還": "还", "繪": "绘", "練": "练", "濤": "涛", "懸": "悬", "緊": "紧", "細": "细", "轟": "轰", "報": "报", "瀾": "澜", "尋": "寻", "閣": "阁", "紡": "纺", "兩": "两", "燴": "烩", "鵑": "鹃", "漢": "汉", "該": "该", "規": "规", "販": "贩", "閒": "闲", "蓮": "莲", "臉": "脸", "觀": "观", "專": "专", "繕": "缮", "約": "约", "爐": "炉", "華": "华", "疊": "叠", "蠍": "蝎", "聖": "圣", "遺": "遗", "遠": "远", "讀": "读", "齡": "龄", "亞": "亚", "從": "从", "萬": "万", "葷": "荤", "紅": "红", "騰": "腾", "禮": "礼", "鄉": "乡", "納": "纳", "輪": "轮", "個": "个", "帥": "帅", "蹤": "踪", "錄": "录", "烏": "乌", "欄": "栏", "岡": "冈", "錫": "锡", "慶": "庆", "帶": "带", "滄": "沧", "貨": "货", "簷": "檐", "悅": "悦", "鍾": "钟", "詳": "详", "離": "离", "頸": "颈", "純": "纯", "夥": "伙", "種": "种", "擋": "挡", "巔": "巅", "論": "论", "燙": "烫", "員": "员", "樞": "枢", "樸": "朴", "舊": "旧", "紹": "绍", "顆": "颗", "畝": "亩", "營": "营", "釣": "钓", "飲": "饮", "濃": "浓", "鶴": "鹤", "艙": "舱", "膩": "腻", "匯": "汇", "築": "筑", "閱": "阅", "閲": "阅", "經": "经", "藝": "艺", "當": "当", "幾": "几", "蒼": "苍", "腸": "肠", "廣": "广", "櫻": "樱", "蘭": "兰", "廳": "厅", "樣": "样", "攝": "摄", "準": "准", "猶": "犹", "鐵": "铁", "陣": "阵", "曬": "晒", "棗": "枣", "絕": "绝", "級": "级", "購": "购", "鯽": "鲫", "蟲": "虫", "閃": "闪", "鈀": "钯", "裏": "里", "異": "异", "單": "单", "馬": "马", "識": "识", "鄧": "邓", "貢": "贡", "強": "强", "崍": "崃", "訂": "订", "躍": "跃", "晉": "晋", "險": "险", "網": "网", "萵": "莴", "釋": "释", "殺": "杀", "鹼": "碱", "贊": "赞", "滷": "卤", "彈": "弹", "筆": "笔", "綜": "综", "碼": "码", "點": "点", "鵪": "鹌", "雖": "虽", "雞": "鸡", "買": "买", "蝦": "虾", "燻": "熏", "冊": "册", "軍": "军", "鏡": "镜", "創": "创", "壓": "压", "調": "调", "温": "溫", "畫": "画", "錯": "错", "銜": "衔", "話": "话", "闊": "阔", "餡": "馅", "剛": "刚", "認": "认", "評": "评", "襪": "袜", "號": "号", "飛": "飞", "彌": "弥", "寧": "宁", "導": "导", "棧": "栈", "運": "运", "風": "风", "餘": "余", "貓": "猫", "傷": "伤", "埡": "垭", "脈": "脉", "賞": "赏", "備": "备", "棲": "栖", "槳": "桨", "復": "复", "動": "动", "瀉": "泻", "進": "进", "飾": "饰", "掛": "挂", "灣": "湾", "趙": "赵", "潤": "润", "醃": "腌", "鱔": "鳝", "極": "极", "聶": "聂", "隕": "陨", "嘗": "尝", "鴦": "鸯", "恆": "恒", "鄰": "邻", "盡": "尽", "蘇": "苏", "嗎": "吗", "滿": "满", "饊": "馓", "貿": "贸", "開": "开", "別": "别", "萊": "莱", "氳": "氲", "涼": "凉", "寵": "宠", "臨": "临", "鳴": "鸣", "頭": "头", "煙": "烟", "氣": "气", "躥": "蹿", "絲": "丝", "傳": "传", "鯊": "鲨", "賃": "赁", "廈": "厦", "費": "费", "紙": "纸", "餵": "喂", "貫": "贯", "確": "确", "態": "态", "續": "续", "窮": "穷", "鑽": "钻", "懷": "怀", "貳": "贰", "內": "内", "櫚": "榈", "歷": "历", "現": "现", "褲": "裤", "藍": "蓝", "團": "团", "譜": "谱", "籠": "笼", "藥": "药", "沒": "没", "鴉": "鸦", "島": "岛", "籤": "签", "願": "愿", "叢": "丛", "蘿": "萝", "騎": "骑", "賓": "宾", "爾": "尔", "組": "组", "處": "处", "電": "电", "蓋": "盖", "書": "书", "稱": "称", "輝": "辉", "預": "预", "繚": "缭", "縱": "纵", "擴": "扩", "艦": "舰", "減": "减", "著": "着", "繼": "继", "崗": "岗", "絡": "络", "張": "张", "體": "体", "儀": "仪", "並": "并", "軟": "软", "燉": "炖", "類": "类", "頁": "页", "鵝": "鹅", "妝": "妆", "亂": "乱", "測": "测", "縮": "缩", "驛": "驿", "飄": "飘", "譚": "谭", "凍": "冻", "紋": "纹", "攤": "摊", "歲": "岁", "髒": "脏", "茲": "兹", "題": "题", "連": "连", "榮": "荣", "況": "况", "決": "决", "額": "额", "箏": "筝", "聲": "声", "賽": "赛", "師": "师", "卧": "臥", "為": "为", "趕": "赶", "寶": "宝", "櫃": "柜", "線": "线", "蔭": "荫", "醬": "酱", "產": "产", "濁": "浊", "僅": "仅", "終": "终", "懶": "懒", "鴨": "鸭", "駱": "骆", "隱": "隐", "欖": "榄", "薈": "荟", "詩": "诗", "劇": "剧", "彎": "弯", "鬱": "郁", "韻": "韵", "羣": "群", "薦": "荐", "暢": "畅", "遷": "迁", "黨": "党", "廂": "厢", "圓": "圆", "誼": "谊", "寬": "宽", "聽": "听", "鳥": "鸟", "擁": "拥", "賴": "赖", "揚": "扬", "軸": "轴", "牆": "墙", "楊": "杨", "爛": "烂", "黃": "黄", "庫": "库", "瘋": "疯", "辦": "办", "陰": "阴", "諸": "诸", "豬": "猪", "羶": "膻", "魷": "鱿", "娛": "娱", "繞": "绕", "漲": "涨", "隊": "队", "絨": "绒", "夠": "够", "鋪": "铺", "擇": "择", "荊": "荆", "攜": "携", "熗": "炝", "盧": "卢", "鹹": "咸", "對": "对", "層": "层", "魚": "鱼", "燒": "烧", "暫": "暂", "劃": "划", "帳": "帐", "靈": "灵", "樂": "乐", "薩": "萨", "虜": "虏", "槓": "杠", "縫": "缝", "適": "适", "側": "侧", "總": "总", "鄒": "邹", "摻": "掺", "斷": "断", "殞": "殒", "範": "范", "軌": "轨", "佔": "占", "薔": "蔷", "輯": "辑", "蠅": "蝇", "顏": "颜", "賀": "贺", "隨": "随", "權": "权", "幹": "干", "樓": "楼", "織": "织", "積": "积", "朧": "胧", "鎮": "镇", "橋": "桥", "儲": "储", "夾": "夹", "謠": "谣", "較": "较", "瑪": "玛", "穩": "稳", "檢": "检", "負": "负", "麗": "丽", "獲": "获", "須": "须", "資": "资", "霧": "雾", "間": "间", "鏈": "链", "麥": "麦", "輛": "辆", "廬": "庐", "順": "顺", "餃": "饺", "寫": "写", "縉": "缙", "國": "国", "覽": "览", "讓": "让", "灘": "滩", "燈": "灯", "釀": "酿", "緒": "绪", "繹": "绎", "鴛": "鸳", "綿": "绵", "陸": "陆", "協": "协", "騾": "骡", "眾": "众", "禪": "禅", "錦": "锦", "擾": "扰", "戲": "戏", "窩": "窝", "軒": "轩", "紀": "纪", "採": "采", "統": "统", "謂": "谓", "鬧": "闹", "廠": "厂", "許": "许", "價": "价", "壺": "壶", "靜": "静", "簡": "简", "飯": "饭", "嘆": "叹", "維": "维", "窯": "窑", "術": "术", "視": "视", "雜": "杂", "勸": "劝", "漿": "浆", "實": "实", "館": "馆", "廝": "厮", "撈": "捞", "財": "财", "樹": "树", "憶": "忆", "腳": "脚", "陳": "陈", "謝": "谢", "鎢": "钨", "結": "结", "鮮": "鲜", "鹽": "盐", "語": "语", "韓": "韩", "長": "长", "棄": "弃", "倉": "仓", "車": "车", "蕎": "荞", "膠": "胶", "輩": "辈", "齋": "斋", "證": "证", "夢": "梦", "構": "构", "漸": "渐", "塗": "涂", "蔥": "葱", "農": "农", "腦": "脑", "盤": "盘", "歸": "归", "訪": "访", "條": "条", "臥": "卧", "計": "计", "戶": "户", "溼": "湿", "濕": "湿", "户": "戶", "卻": "却", "曉": "晓", "託": "托", "俠": "侠", "媽": "妈", "澤": "泽", "請": "请", "紐": "纽", "獎": "奖", "銳": "锐", "鋭": "锐", "飼": "饲", "餞": "饯", "豐": "丰", "鍵": "键", "兒": "儿", "譽": "誉", "東": "东", "場": "场", "園": "园", "鋼": "钢", "鯨": "鲸", "選": "选", "詢": "询", "勢": "势", "鳳": "凤", "則": "则", "變": "变", "濱": "滨", "凱": "凯", "業": "业", "鎖": "锁", "課": "课", "壽": "寿", "啟": "启", "啓": "启", "頓": "顿", "會": "会", "頗": "颇", "親": "亲", "門": "门", "鰍": "鳅", "稅": "税", "貼": "贴", "蹺": "跷", "滾": "滚", "賦": "赋", "鷺": "鹭", "紗": "纱", "陝": "陕", "飪": "饪", "菸": "烟", "闆": "板", "鞦": "秋", "垻": "坝", "蔔": "卜", "儘": "尽", "鱂": "鳉", "臟": "脏", "併": "并", "紮": "扎", "鐘": "钟", "盪": "荡", "複": "复", "週": "周", "誌": "志", "薑": "姜", "糰": "团", "韆": "千", "膽": "胆", "畢": "毕", "捨": "舍", "聰": "聪", "迴": "回", "穀": "谷", "緣": "缘", "驚": "惊", "檯": "台", "輸": "输", "緻": "致", "蹟": "迹", "鬆": "松", "罈": "坛", "孃": "娘", "禦": "御", "註": "注", "製": "制", "係": "系"};
