const PLACES = [
 ...
 {
  "name": "蟹樂町·蟹專門店（遠洋太古里店）",
  "city": "成都",
  "category": "海鮮",
  "halal": false,
  "cuisine": "日式活蟹專門店（活帝王蟹/松葉蟹單點）",
  "area": "錦江區·太古里",
  "address": "成都市錦江區遠洋太古里2208（西糠市街，Apple/Tiffany旁上二樓）",
  "lat": 30.6524,
  "lng": 104.0808,
  "hours": "約11:30-22:00",
  "price": "帝王蟹約¥980/斤、人均¥500+",
  "rating": null,
  "rating_source": null,
  "dishes": [
   "活帝王蟹一蟹多吃",
  ...
  "reason": "成都第一家活蟹專門店，帝王蟹/松葉蟹現挑現做、可單點一蟹多吃；就在太古里，是雍容薈自助之外的單點選擇。",
  "notes": "日式蟹料理專門店、以蟹為主幾乎無豬肉，避豬最省心（非清真，仍留意高湯配菜）；另收餐位費、人均偏高；建議大眾點評線上訂位。大眾點評精確評分因反爬未取得，訂前建議用App查一次。"
 },
 {
  "name": "青石橋海鮮市場（代客加工）",
  "city": "成都",
