const PLACES = [
 ...
 },
 {
  ...
  "cuisine": "川味螃蟹·小海鮮大排檔",
  "area": "成華區·祥和里",
  "address": "成都市成華區一環路東三段祥和里54號（近玉雙路地鐵站）",
  "lat": 30.6645,
  "lng": 104.093,
  "hours": "約17:00-次日02:00（宵夜為主，以門店為準）",
  "price": "人均約¥81（帝王蟹若代訂按時價）",
  "rating": "4.3/5",
  "rating_source": "攜程（約66條，評論最多）",
  "dishes": [
   "蟹蟹麵（網紅）",
   "香辣蟹",
   "爆炒蟶子",
  ...
  "reason": "在地人氣川味蟹與小海鮮大排檔，評論數最多、口碑相對扎實；宵夜氣氛佳。",
  "notes": "非清真，以蟹與海鮮為主、個別川菜可能含豬；主打本地川味蟹，帝王蟹非主打、要活帝王蟹需事先詢問。"
 },
 {
  "name": "樓上大排檔·海鮮·燒臘（太古里店）",
  "city": "成都",
  "category": "午晚餐",
  "halal": false,
  "cuisine": "粵式海鮮大排檔（啫啫煲·明爐燒臘·順德魚生）",
  "area": "錦江區·太古里",
  "address": "成都市錦江區下東大街段169號晶融匯二期2樓（近太古里）",
  "lat": 30.651,
  "lng": 104.0835,
  "hours": "約11:00-14:00、17:00-22:00（以門店為準）",
  "price": "人均約¥100（帝王蟹若有按時價）",
  "rating": "5.0/5",
  "rating_source": "攜程（僅3條，樣本少）",
  "dishes": [
   "瘋狂胡椒蝦",
   "辣啫四季豆",
   "廣式明爐燒鵝",
  ...
  "reason": "近太古里的粵式海鮮大排檔，單點海鮮＋啫啫煲；位置方便，是太古里一帶的海鮮選擇。",
  "notes": "非清真、有黑叉燒等燒臘豬肉需避開，燒鵝與海鮮可點；帝王蟹非主打、菜單未明確，需現場詢問是否有活蟹。電話19113239505。"
 },
 {
  "name": "青石橋海鮮市場（代客加工）",
  "city": "成都",
  ...
  "area": "錦江區·青石橋",
  "address": "成都市錦江區青石橋中街（近春熙路、鹽市口）",
  "lat": 30.6552,
  "lng": 104.0783,
  "hours": "約08:00-22:00（各攤不一）",
  "price": "活帝王蟹秤重市價＋加工費另計",
  "rating": null,
  "rating_source": null,
  "dishes": [
   "活帝王蟹一蟹三吃",
  ...
  "reason": "成都最大水產市場，可自挑活帝王蟹秤重、拿到代客加工攤做一蟹三吃；最道地彈性、位置近春熙路。",
  "notes": "加工以海鮮為主、避豬容易（非清真）；認明公平秤、事先講好價格做法與衛生。"
 },
 {
 ...
 },
 {
  ...
  "notes": "全網實名預約、現場原則上不售票；建議預留4-5小時並租語音導覽或預約人工講解。成都東站乘城際列車至廣漢北站，再打車約20分鐘。",
  "duration": "4-5小時",
  "city": "成都"
 },
 {
...
const T2S = {"麵": "面", "裡": "里", "遊": "游", "隻": "只", "乾": "干", "後": "后", "髮": "发", "於": "于", "臺": "台", "嚐": "尝", "採": "采", "邁": "迈", "態": "态", "廚": "厨", "頗": "颇", "魚": "鱼", "佔": "占", "鐵": "铁", "啟": "启", "啓": "启", "業": "业", "計": "计", "鯊": "鲨", "傷": "伤", "龐": "庞", "廟": "庙", "葷": "荤", "產": "产", "獎": "奖", "駕": "驾", "爾": "尔", "礦": "矿", "亂": "乱", "鯽": "鲫", "圓": "圆", "艦": "舰", "嬌": "娇", "擁": "拥", "賣": "卖", "統": "统", "兒": "儿", "證": "证", "別": "别", "閱": "阅", "閲": "阅", "構": "构", "鑽": "钻", "過": "过", "橋": "桥", "貿": "贸", "組": "组", "銀": "银", "嶺": "岭", "視": "视", "現": "现", "駱": "骆", "紡": "纺", "滾": "滚", "給": "给", "葉": "叶", "奧": "奥", "顧": "顾", "興": "兴", "瘋": "疯", "認": "认", "窯": "窑", "跡": "迹", "剎": "刹", "湊": "凑", "規": "规", "臨": "临", "寧": "宁", "兩": "两", "詞": "词", "場": "场", "稅": "税", "軍": "军", "卧": "臥", "鄧": "邓", "樞": "枢", "吳": "吴", "蒼": "苍", "報": "报", "庫": "库", "凱": "凯", "褲": "裤", "宮": "宫", "剛": "刚", "聯": "联", "匯": "汇", "驗": "验", "儀": "仪", "勢": "势", "鋼": "钢", "銳": "锐", "鋭": "锐", "脈": "脉", "欖": "榄", "燒": "烧", "擔": "担", "卻": "却", "維": "维", "瀾": "澜", "許": "许", "鵪": "鹌", "氣": "气", "薦": "荐", "崗": "岗", "餃": "饺", "饊": "馓", "貨": "货", "機": "机", "蝦": "虾", "補": "补", "時": "时", "歡": "欢", "峽": "峡", "繹": "绎", "暢": "畅", "掃": "扫", "鷗": "鸥", "轟": "轰", "詩": "诗", "圖": "图", "腳": "脚", "營": "营", "腦": "脑", "還": "还", "魨": "鲀", "護": "护", "寫": "写", "隱": "隐", "陽": "阳", "鷺": "鹭", "順": "顺", "磚": "砖", "嚴": "严", "緒": "绪", "筆": "笔", "鉑": "铂", "頂": "顶", "遠": "远", "賃": "赁", "鬧": "闹", "勞": "劳", "縱": "纵", "標": "标", "鯉": "鲤", "劇": "剧", "廳": "厅", "烏": "乌", "達": "达", "蘿": "萝", "樓": "楼", "層": "层", "軟": "软", "曉": "晓", "國": "国", "鳳": "凤", "漸": "渐", "頓": "顿", "鷹": "鹰", "霧": "雾", "幫": "帮", "沒": "没", "賴": "赖", "樹": "树", "燈": "灯", "間": "间", "園": "园", "謝": "谢", "闊": "阔", "钂": "镋", "務": "务", "紐": "纽", "災": "灾", "領": "领", "諸": "诸", "槳": "桨", "連": "连", "滄": "沧", "鵑": "鹃", "東": "东", "縣": "县", "買": "买", "貴": "贵", "屬": "属", "課": "课", "寬": "宽", "么": "幺", "萬": "万", "鯨": "鲸", "攪": "搅", "繞": "绕", "專": "专", "雞": "鸡", "盧": "卢", "飛": "飞", "醬": "酱", "盡": "尽", "繚": "缭", "鈀": "钯", "練": "练", "錢": "钱", "餞": "饯", "親": "亲", "樸": "朴", "疊": "叠", "圍": "围", "貫": "贯", "擺": "摆", "莊": "庄", "壩": "坝", "語": "语", "淨": "净", "復": "复", "賓": "宾", "評": "评", "櫃": "柜", "請": "请", "騎": "骑", "來": "来", "協": "协", "壓": "压", "詳": "详", "蠅": "蝇", "瀉": "泻", "環": "环", "紙": "纸", "備": "备", "鄉": "乡", "確": "确", "劉": "刘", "餵": "喂", "揚": "扬", "鬥": "斗", "積": "积", "彌": "弥", "貝": "贝", "寶": "宝", "妝": "妆", "腸": "肠", "輪": "轮", "穩": "稳", "飲": "饮", "廠": "厂", "舊": "旧", "撈": "捞", "鄒": "邹", "讓": "让", "邊": "边", "賞": "赏", "夾": "夹", "餘": "余", "岡": "冈", "閃": "闪", "資": "资", "棄": "弃", "應": "应", "聲": "声", "臥": "卧", "簡": "简", "荊": "荆", "儲": "储", "飾": "饰", "禮": "礼", "頸": "颈", "魷": "鱿", "講": "讲", "肅": "肃", "澆": "浇", "燜": "焖", "擾": "扰", "內": "内", "凍": "冻", "歲": "岁", "榮": "荣", "蹺": "跷", "鹼": "碱", "邏": "逻", "勸": "劝", "窩": "窝", "饢": "馕", "趙": "赵", "輝": "辉", "狀": "状", "險": "险", "設": "设", "論": "论", "發": "发", "龔": "龚", "擬": "拟", "響": "响", "傘": "伞", "參": "参", "潤": "润", "攝": "摄", "誕": "诞", "龍": "龙", "這": "这", "訂": "订", "鳥": "鸟", "頁": "页", "蔣": "蒋", "軸": "轴", "記": "记", "瑪": "玛", "雜": "杂", "運": "运", "貓": "猫", "贊": "赞", "蟬": "蝉", "軒": "轩", "終": "终", "與": "与", "賦": "赋", "載": "载", "鵝": "鹅", "潔": "洁", "範": "范", "藥": "药", "溫": "温", "溼": "湿", "濕": "湿", "燻": "熏", "鳴": "鸣", "撻": "挞", "陝": "陕", "駐": "驻", "階": "阶", "曬": "晒", "巖": "岩", "壺": "壶", "錯": "错", "粵": "粤", "涼": "凉", "稱": "称", "蕎": "荞", "釣": "钓", "雖": "虽", "倉": "仓", "覓": "觅", "隊": "队", "陣": "阵", "適": "适", "頭": "头", "覺": "觉", "軌": "轨", "際": "际", "嘆": "叹", "豔": "艳", "欄": "栏", "湧": "涌", "決": "决", "幹": "干", "龜": "龟", "購": "购", "從": "从", "奪": "夺", "萊": "莱", "騰": "腾", "遷": "迁", "户": "戶", "熱": "热", "懸": "悬", "慶": "庆", "櫻": "樱", "島": "岛", "膠": "胶", "鍵": "键", "禪": "禅", "綠": "绿", "銅": "铜", "負": "负", "俠": "侠", "觀": "观", "著": "着", "聞": "闻", "鹹": "咸", "額": "额", "壇": "坛", "悅": "悦", "魯": "鲁", "輛": "辆", "鹽": "盐", "覽": "览", "說": "说", "説": "说", "麼": "么", "陸": "陆", "鈔": "钞", "萵": "莴", "脫": "脱", "爺": "爷", "濱": "滨", "籠": "笼", "數": "数", "約": "约", "氳": "氲", "譜": "谱", "節": "节", "嗎": "吗", "蔥": "葱", "顏": "颜", "灣": "湾", "戶": "户", "夢": "梦", "裏": "里", "漲": "涨", "緊": "紧", "輩": "辈", "鴉": "鸦", "單": "单", "餈": "糍", "樣": "样", "擴": "扩", "廂": "厢", "愛": "爱", "門": "门", "選": "选", "費": "费", "類": "类", "權": "权", "續": "续", "輕": "轻", "養": "养", "溝": "沟", "髒": "脏", "編": "编", "殺": "杀", "處": "处", "謠": "谣", "廈": "厦", "譚": "谭", "豐": "丰", "絨": "绒", "棲": "栖", "漿": "浆", "勝": "胜", "較": "较", "犛": "牦", "熗": "炝", "紉": "纫", "問": "问", "馬": "马", "暫": "暂", "細": "细", "僅": "仅", "勁": "劲", "齡": "龄", "綴": "缀", "幾": "几", "獅": "狮", "彎": "弯", "閣": "阁", "擠": "挤", "團": "团", "恆": "恒", "窮": "穷", "帳": "帐", "兇": "凶", "織": "织", "躍": "跃", "羅": "罗", "摻": "掺", "創": "创", "埡": "垭", "減": "减", "釋": "释", "術": "术", "農": "农", "關": "关", "鑑": "鉴", "薈": "荟", "戰": "战", "聶": "聂", "亞": "亚", "槓": "杠", "託": "托", "筍": "笋", "販": "贩", "郵": "邮", "職": "职", "網": "网", "飽": "饱", "紀": "纪", "強": "强", "絕": "绝", "檔": "档", "電": "电", "鴦": "鸯", "獲": "获", "綜": "综", "銜": "衔", "賬": "账", "譽": "誉", "預": "预", "無": "无", "擋": "挡", "進": "进", "眾": "众", "員": "员", "漁": "渔", "茲": "兹", "艙": "舱", "貼": "贴", "饞": "馋", "張": "张", "劃": "划", "為": "为", "齊": "齐", "風": "风", "純": "纯", "縉": "缙", "蓋": "盖", "頻": "频", "鰍": "鳅", "紋": "纹", "換": "换", "寵": "宠", "線": "线", "崍": "崃", "議": "议", "羶": "膻", "黃": "黄", "飄": "飘", "鋪": "铺", "車": "车", "擇": "择", "娛": "娱", "憶": "忆", "殞": "殒", "閉": "闭", "優": "优", "貳": "贰", "試": "试", "帶": "带", "麥": "麦", "灩": "滟", "蠍": "蝎", "鄰": "邻", "虜": "虏", "條": "条", "巔": "巅", "陳": "陈", "塗": "涂", "檢": "检", "並": "并", "壽": "寿", "鎮": "镇", "願": "愿", "繕": "缮", "題": "题", "攜": "携", "繪": "绘", "會": "会", "賀": "贺", "納": "纳", "靜": "静", "櫚": "榈", "轉": "转", "猶": "犹", "棟": "栋", "鶉": "鹑", "鮮": "鲜", "樂": "乐", "則": "则", "畫": "画", "識": "识", "離": "离", "該": "该", "濤": "涛", "頌": "颂", "紅": "红", "掛": "挂", "辦": "办", "籤": "签", "鰱": "鲢", "膩": "腻", "濁": "浊", "須": "须", "訓": "训", "藍": "蓝", "嶽": "岳", "冊": "册", "壯": "壮", "歸": "归", "橫": "横", "談": "谈", "顯": "显", "難": "难", "當": "当", "隨": "随", "體": "体", "醃": "腌", "鴛": "鸳", "滿": "满", "輯": "辑", "錦": "锦", "紹": "绍", "話": "话", "澤": "泽", "藝": "艺", "極": "极", "蔭": "荫", "懷": "怀", "麗": "丽", "傳": "传", "飼": "饲", "彈": "弹", "訪": "访", "餚": "肴", "師": "师", "煙": "烟", "尋": "寻", "紗": "纱", "塊": "块", "箏": "筝", "懶": "懒", "縮": "缩", "漬": "渍", "撲": "扑", "蘇": "苏", "臘": "腊", "鍋": "锅", "薔": "蔷", "温": "溫", "項": "项", "媽": "妈", "繼": "继", "臉": "脸", "財": "财", "燉": "炖", "峯": "峰", "蹤": "踪", "餡": "馅", "質": "质", "貢": "贡", "訊": "讯", "夥": "伙", "棗": "枣", "聽": "听", "書": "书", "讀": "读", "釀": "酿", "爛": "烂", "牆": "墙", "畝": "亩", "韓": "韩", "蟲": "虫", "導": "导", "調": "调", "斷": "断", "隕": "陨", "經": "经", "棧": "栈", "將": "将", "慮": "虑", "鏈": "链", "號": "号", "羣": "群", "級": "级", "蘆": "芦", "碼": "码", "錫": "锡", "錄": "录", "針": "针", "況": "况", "鍾": "钟", "飪": "饪", "戲": "戏", "動": "动", "誼": "谊", "啞": "哑", "攤": "摊", "個": "个", "區": "区", "實": "实", "靈": "灵", "遺": "遗", "種": "种", "變": "变", "趕": "赶", "長": "长", "謂": "谓", "釐": "厘", "漢": "汉", "陰": "阴", "濃": "浓", "醫": "医", "絲": "丝", "結": "结", "嗆": "呛", "裝": "装", "囪": "囱", "廬": "庐", "鶴": "鹤", "鎢": "钨", "蘭": "兰", "對": "对", "滷": "卤", "點": "点", "湯": "汤", "薩": "萨", "歷": "历", "華": "华", "價": "价", "濟": "济", "銷": "销", "徑": "径", "賽": "赛", "聖": "圣", "齋": "斋", "衝": "冲", "簷": "檐", "擼": "撸", "側": "侧", "淵": "渊", "嘗": "尝", "駁": "驳", "縫": "缝", "見": "见", "飯": "饭", "雲": "云", "顆": "颗", "廝": "厮", "餅": "饼", "帥": "帅", "據": "据", "鱔": "鳝", "鎖": "锁", "揮": "挥", "黨": "党", "朧": "胧", "準": "准", "鬱": "郁", "綿": "绵", "閒": "闲", "絡": "络", "鴨": "鸭", "館": "馆", "學": "学", "詢": "询", "築": "筑", "騾": "骡", "燴": "烩", "燙": "烫", "楊": "杨", "駝": "驼", "鮑": "鲍", "總": "总", "搶": "抢", "灘": "滩", "異": "异", "夠": "够", "鏡": "镜", "缽": "钵", "鈴": "铃", "義": "义", "豬": "猪", "襪": "袜", "雙": "双", "驛": "驿", "叢": "丛", "獨": "独", "蓮": "莲", "盤": "盘", "爐": "炉", "晉": "晋", "躥": "蹿", "韻": "韵", "廣": "广", "測": "测", "開": "开", "緣": "缘", "製": "制", "誌": "志", "捨": "舍", "韆": "千", "孃": "娘", "併": "并", "糰": "团", "禦": "御", "罈": "坛", "臟": "脏", "蹟": "迹", "畢": "毕", "垻": "坝", "菸": "烟", "紮": "扎", "緻": "致", "檯": "台", "膽": "胆", "迴": "回", "鐘": "钟", "聰": "聪", "盪": "荡", "註": "注", "闆": "板", "薑": "姜", "複": "复", "驚": "惊", "週": "周", "係": "系", "蔔": "卜", "鬆": "松", "鱂": "鳉", "鞦": "秋", "儘": "尽", "輸": "输", "穀": "谷"};
