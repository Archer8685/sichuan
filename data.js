...
const T2S = {"麵": "面", "裡": "里", "遊": "游", "隻": "只", "乾": "干", "後": "后", "髮": "发", "於": "于", "臺": "台", "嚐": "尝", "願": "愿", "齊": "齐", "緊": "紧", "縉": "缙", "繼": "继", "盡": "尽", "趙": "赵", "壯": "壮", "職": "职", "涼": "凉", "襪": "袜", "鄧": "邓", "嚴": "严", "業": "业", "單": "单", "際": "际", "瀉": "泻", "處": "处", "紡": "纺", "魚": "鱼", "揚": "扬", "嶽": "岳", "來": "来", "瀾": "澜", "溫": "温", "恆": "恒", "納": "纳", "貫": "贯", "費": "费", "滿": "满", "暫": "暂", "釋": "释", "傳": "传", "緒": "绪", "級": "级", "妝": "妆", "個": "个", "蘆": "芦", "採": "采", "懷": "怀", "繞": "绕", "壓": "压", "報": "报", "鷺": "鹭", "釀": "酿", "顧": "顾", "鯽": "鲫", "宮": "宫", "積": "积", "鹽": "盐", "譜": "谱", "囪": "囱", "遷": "迁", "國": "国", "沒": "没", "陸": "陆", "過": "过", "氳": "氲", "聞": "闻", "筆": "笔", "變": "变", "蔥": "葱", "統": "统", "臘": "腊", "朧": "胧", "鏈": "链", "疊": "叠", "該": "该", "劇": "剧", "師": "师", "謝": "谢", "產": "产", "幾": "几", "經": "经", "滾": "滚", "絕": "绝", "錢": "钱", "鴦": "鸯", "巔": "巅", "槓": "杠", "樞": "枢", "謠": "谣", "裏": "里", "闊": "阔", "鷹": "鹰", "猶": "犹", "這": "这", "書": "书", "醫": "医", "動": "动", "歷": "历", "連": "连", "鍋": "锅", "虜": "虏", "熗": "炝", "崗": "岗", "箏": "筝", "讓": "让", "頁": "页", "線": "线", "檔": "档", "備": "备", "钂": "镋", "編": "编", "凱": "凯", "兇": "凶", "靜": "静", "佔": "占", "紹": "绍", "灣": "湾", "輕": "轻", "霧": "雾", "舊": "旧", "結": "结", "澤": "泽", "隊": "队", "極": "极", "殺": "杀", "鄉": "乡", "陳": "陈", "嶺": "岭", "顆": "颗", "繹": "绎", "張": "张", "許": "许", "么": "幺", "卧": "臥", "橫": "横", "勞": "劳", "衝": "冲", "脫": "脱", "鍵": "键", "術": "术", "劃": "划", "籠": "笼", "區": "区", "攤": "摊", "爐": "炉", "訓": "训", "題": "题", "閃": "闪", "輯": "辑", "蟬": "蝉", "務": "务", "鐵": "铁", "現": "现", "館": "馆", "優": "优", "鎢": "钨", "鰱": "鲢", "萬": "万", "發": "发", "請": "请", "創": "创", "鶉": "鹑", "帶": "带", "滷": "卤", "約": "约", "幹": "干", "聽": "听", "項": "项", "戶": "户", "雜": "杂", "豔": "艳", "貳": "贰", "跡": "迹", "樂": "乐", "興": "兴", "餘": "余", "鬥": "斗", "駱": "骆", "臨": "临", "將": "将", "側": "侧", "軟": "软", "儲": "储", "鴨": "鸭", "鹹": "咸", "羶": "膻", "陝": "陕", "鬧": "闹", "郵": "邮", "擇": "择", "島": "岛", "遺": "遗", "貨": "货", "幫": "帮", "攝": "摄", "鯉": "鲤", "擴": "扩", "軒": "轩", "覓": "觅", "貢": "贡", "辦": "办", "雲": "云", "膩": "腻", "廬": "庐", "參": "参", "戰": "战", "觀": "观", "紙": "纸", "銅": "铜", "濟": "济", "盤": "盘", "俠": "侠", "蠅": "蝇", "顯": "显", "煙": "烟", "紉": "纫", "聖": "圣", "數": "数", "畫": "画", "鵑": "鹃", "褲": "裤", "慶": "庆", "鉑": "铂", "著": "着", "彈": "弹", "環": "环", "護": "护", "賣": "卖", "鳴": "鸣", "慮": "虑", "濃": "浓", "繕": "缮", "邏": "逻", "屬": "属", "嗆": "呛", "曬": "晒", "縱": "纵", "鋪": "铺", "順": "顺", "峽": "峡", "啟": "启", "啓": "启", "寫": "写", "贊": "赞", "領": "领", "東": "东", "誕": "诞", "懸": "悬", "賞": "赏", "駕": "驾", "釣": "钓", "應": "应", "細": "细", "聶": "聂", "壺": "壶", "會": "会", "烏": "乌", "廝": "厮", "補": "补", "驛": "驿", "濱": "滨", "瘋": "疯", "燴": "烩", "僅": "仅", "豐": "丰", "溼": "湿", "濕": "湿", "楊": "杨", "陣": "阵", "議": "议", "棟": "栋", "寵": "宠", "棄": "弃", "紗": "纱", "餞": "饯", "譽": "誉", "錫": "锡", "熱": "热", "標": "标", "廟": "庙", "碼": "码", "灩": "滟", "樸": "朴", "鑽": "钻", "燒": "烧", "頗": "颇", "鄒": "邹", "總": "总", "飛": "飞", "龔": "龚", "冊": "册", "趕": "赶", "斷": "断", "蓮": "莲", "築": "筑", "漁": "渔", "榮": "荣", "葉": "叶", "詩": "诗", "語": "语", "別": "别", "識": "识", "漲": "涨", "髒": "脏", "擼": "撸", "財": "财", "漢": "汉", "飯": "饭", "寧": "宁", "饢": "馕", "縮": "缩", "鴛": "鸳", "難": "难", "壩": "坝", "訂": "订", "薔": "蔷", "樹": "树", "饊": "馓", "窮": "穷", "閱": "阅", "閲": "阅", "豬": "猪", "鎖": "锁", "擾": "扰", "圖": "图", "櫃": "柜", "錦": "锦", "麼": "么", "嘆": "叹", "簷": "檐", "長": "长", "軍": "军", "剛": "刚", "餅": "饼", "記": "记", "鱔": "鳝", "窯": "窑", "問": "问", "詢": "询", "寬": "宽", "進": "进", "氣": "气", "蟲": "虫", "試": "试", "峯": "峰", "庫": "库", "達": "达", "裝": "装", "殞": "殒", "頌": "颂", "憶": "忆", "當": "当", "爛": "烂", "脈": "脉", "頂": "顶", "橋": "桥", "運": "运", "頓": "顿", "買": "买", "員": "员", "體": "体", "龜": "龟", "鄰": "邻", "鹼": "碱", "溝": "沟", "隕": "陨", "蓋": "盖", "繪": "绘", "輝": "辉", "灘": "滩", "燙": "烫", "棧": "栈", "並": "并", "濤": "涛", "湧": "涌", "換": "换", "廂": "厢", "餵": "喂", "韻": "韵", "粵": "粤", "温": "溫", "騾": "骡", "鯊": "鲨", "羅": "罗", "湯": "汤", "協": "协", "蠍": "蝎", "蹤": "踪", "懶": "懒", "鎮": "镇", "蝦": "虾", "轟": "轰", "户": "戶", "況": "况", "寶": "宝", "掛": "挂", "軌": "轨", "餈": "糍", "軸": "轴", "調": "调", "檢": "检", "鯨": "鲸", "絡": "络", "鑑": "鉴", "叢": "丛", "愛": "爱", "澆": "浇", "組": "组", "晉": "晋", "鮑": "鲍", "與": "与", "鷗": "鸥", "認": "认", "膠": "胶", "欖": "榄", "欄": "栏", "賽": "赛", "導": "导", "鰍": "鳅", "蹺": "跷", "兒": "儿", "廈": "厦", "臥": "卧", "搶": "抢", "塊": "块", "謂": "谓", "隱": "隐", "態": "态", "練": "练", "勸": "劝", "礦": "矿", "聯": "联", "針": "针", "擋": "挡", "埡": "垭", "權": "权", "禮": "礼", "娛": "娱", "見": "见", "壽": "寿", "貴": "贵", "託": "托", "餃": "饺", "隨": "随", "譚": "谭", "腦": "脑", "擠": "挤", "絲": "丝", "網": "网", "選": "选", "擁": "拥", "鳥": "鸟", "層": "层", "圍": "围", "燉": "炖", "廳": "厅", "傘": "伞", "離": "离", "驗": "验", "龐": "庞", "勁": "劲", "櫻": "樱", "麗": "丽", "獲": "获", "棲": "栖", "夠": "够", "雙": "双", "質": "质", "時": "时", "莊": "庄", "靈": "灵", "蕎": "荞", "話": "话", "輪": "轮", "織": "织", "農": "农", "證": "证", "嘗": "尝", "蘭": "兰", "載": "载", "棗": "枣", "雖": "虽", "歡": "欢", "額": "额", "漸": "渐", "縣": "县", "齡": "龄", "貿": "贸", "顏": "颜", "穩": "稳", "遠": "远", "銜": "衔", "夢": "梦", "艙": "舱", "彎": "弯", "營": "营", "邁": "迈", "號": "号", "亞": "亚", "籤": "签", "黨": "党", "談": "谈", "駁": "驳", "紀": "纪", "圓": "圆", "魨": "鲀", "確": "确", "樓": "楼", "陽": "阳", "災": "灾", "鈀": "钯", "儀": "仪", "風": "风", "貝": "贝", "曉": "晓", "尋": "寻", "薩": "萨", "蘇": "苏", "掃": "扫", "評": "评", "滄": "沧", "實": "实", "鵪": "鹌", "飄": "飘", "鋼": "钢", "韓": "韩", "淵": "渊", "閣": "阁", "釐": "厘", "讀": "读", "彌": "弥", "銀": "银", "齋": "斋", "陰": "阴", "內": "内", "賃": "赁", "貼": "贴", "擔": "担", "麥": "麦", "設": "设", "賓": "宾", "吳": "吴", "諸": "诸", "帳": "帐", "樣": "样", "鍾": "钟", "終": "终", "倉": "仓", "頻": "频", "詳": "详", "門": "门", "為": "为", "薦": "荐", "純": "纯", "綠": "绿", "稅": "税", "訪": "访", "絨": "绒", "醬": "酱", "蔣": "蒋", "開": "开", "強": "强", "無": "无", "腸": "肠", "頸": "颈", "轉": "转", "筍": "笋", "範": "范", "稱": "称", "騎": "骑", "啞": "哑", "腳": "脚", "紐": "纽", "牆": "墙", "給": "给", "種": "种", "綜": "综", "機": "机", "飲": "饮", "燜": "焖", "櫚": "榈", "賦": "赋", "銳": "锐", "鋭": "锐", "錄": "录", "鵝": "鹅", "蔭": "荫", "續": "续", "構": "构", "電": "电", "歸": "归", "鴉": "鸦", "廚": "厨", "間": "间", "獎": "奖", "媽": "妈", "從": "从", "岡": "冈", "擬": "拟", "醃": "腌", "飪": "饪", "徑": "径", "揮": "挥", "葷": "荤", "戲": "戏", "蒼": "苍", "復": "复", "燈": "灯", "嗎": "吗", "講": "讲", "萵": "莴", "濁": "浊", "飽": "饱", "則": "则", "艦": "舰", "夾": "夹", "親": "亲", "規": "规", "減": "减", "說": "说", "説": "说", "飾": "饰", "臉": "脸", "決": "决", "燻": "熏", "論": "论", "車": "车", "亂": "乱", "劉": "刘", "節": "节", "購": "购", "聲": "声", "條": "条", "預": "预", "視": "视", "摻": "掺", "綿": "绵", "凍": "冻", "訊": "讯", "廠": "厂", "準": "准", "夥": "伙", "魯": "鲁", "階": "阶", "繚": "缭", "磚": "砖", "淨": "净", "漬": "渍", "剎": "刹", "塗": "涂", "飼": "饲", "覺": "觉", "躥": "蹿", "異": "异", "鮮": "鲜", "餡": "馅", "輩": "辈", "狀": "状", "紅": "红", "藝": "艺", "龍": "龙", "閉": "闭", "課": "课", "薈": "荟", "鳳": "凤", "錯": "错", "眾": "众", "鏡": "镜", "巖": "岩", "蘿": "萝", "魷": "鱿", "瑪": "玛", "賴": "赖", "匯": "汇", "園": "园", "場": "场", "紋": "纹", "維": "维", "盧": "卢", "撈": "捞", "羣": "群", "傷": "伤", "販": "贩", "缽": "钵", "歲": "岁", "縫": "缝", "據": "据", "奧": "奥", "貓": "猫", "鈔": "钞", "華": "华", "窩": "窝", "暢": "畅", "騰": "腾", "畝": "亩", "頭": "头", "悅": "悦", "駐": "驻", "鬱": "郁", "計": "计", "撲": "扑", "學": "学", "鶴": "鹤", "勢": "势", "攜": "携", "專": "专", "還": "还", "潤": "润", "關": "关", "覽": "览", "獅": "狮", "銷": "销", "勝": "胜", "崍": "崃", "險": "险", "負": "负", "閒": "闲", "資": "资", "須": "须", "賀": "贺", "藍": "蓝", "躍": "跃", "壇": "坛", "義": "义", "類": "类", "黃": "黄", "點": "点", "價": "价", "誼": "谊", "簡": "简", "茲": "兹", "湊": "凑", "測": "测", "雞": "鸡", "兩": "两", "馬": "马", "適": "适", "輛": "辆", "爾": "尔", "獨": "独", "擺": "摆", "卻": "却", "養": "养", "帥": "帅", "團": "团", "較": "较", "漿": "浆", "禪": "禅", "荊": "荆", "萊": "莱", "槳": "桨", "廣": "广", "撻": "挞", "藥": "药", "響": "响", "邊": "边", "饞": "馋", "對": "对", "穀": "谷", "臟": "脏", "捨": "舍", "蹟": "迹", "誌": "志", "罈": "坛", "週": "周", "薑": "姜", "驚": "惊", "註": "注", "輸": "输", "垻": "坝", "鐘": "钟", "闆": "板", "迴": "回", "膽": "胆", "鬆": "松", "鱂": "鳉", "係": "系", "聰": "聪", "菸": "烟", "禦": "御", "畢": "毕", "韆": "千", "盪": "荡", "緣": "缘", "蔔": "卜", "鞦": "秋", "糰": "团", "儘": "尽", "孃": "娘", "紮": "扎", "緻": "致", "製": "制", "併": "并", "檯": "台", "複": "复"};
