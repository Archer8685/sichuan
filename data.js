const PLACES = [
 ...
 },
 {
  ...
  "notes": "百度地圖收錄POI，緊鄰重慶清真寺與慶聚齋；主營零售，適合自炊住客與伴手禮採購。",
  "type": "商场"
 },
 {
...
const T2S = {"麵": "面", "裡": "里", "遊": "游", "隻": "只", "乾": "干", "後": "后", "髮": "发", "於": "于", "臺": "台", "嚐": "尝", "獨": "独", "跡": "迹", "揮": "挥", "碼": "码", "淨": "净", "幾": "几", "員": "员", "龜": "龟", "萊": "莱", "錄": "录", "頓": "顿", "組": "组", "鴛": "鸳", "創": "创", "資": "资", "烏": "乌", "裏": "里", "躍": "跃", "門": "门", "峽": "峡", "誕": "诞", "廠": "厂", "蘭": "兰", "聲": "声", "頸": "颈", "統": "统", "閒": "闲", "棄": "弃", "殺": "杀", "雙": "双", "幹": "干", "鋪": "铺", "褲": "裤", "盧": "卢", "鮮": "鲜", "島": "岛", "體": "体", "規": "规", "攝": "摄", "顆": "颗", "復": "复", "啞": "哑", "檔": "档", "貢": "贡", "倉": "仓", "圖": "图", "協": "协", "娛": "娱", "軸": "轴", "車": "车", "當": "当", "廣": "广", "備": "备", "艦": "舰", "餈": "糍", "爛": "烂", "連": "连", "區": "区", "飼": "饲", "輩": "辈", "頗": "颇", "魨": "鲀", "導": "导", "齊": "齐", "齋": "斋", "陰": "阴", "蕎": "荞", "宮": "宫", "擠": "挤", "絕": "绝", "楊": "杨", "聞": "闻", "傘": "伞", "網": "网", "寫": "写", "過": "过", "親": "亲", "妝": "妆", "臉": "脸", "虜": "虏", "謝": "谢", "遠": "远", "鈀": "钯", "義": "义", "臨": "临", "問": "问", "繚": "缭", "瑪": "玛", "漿": "浆", "紐": "纽", "餘": "余", "揚": "扬", "縣": "县", "漲": "涨", "鄧": "邓", "樸": "朴", "夾": "夹", "擺": "摆", "補": "补", "運": "运", "擾": "扰", "點": "点", "請": "请", "飲": "饮", "駐": "驻", "飯": "饭", "壺": "壶", "悅": "悦", "襪": "袜", "輕": "轻", "濱": "滨", "麥": "麦", "錢": "钱", "湊": "凑", "鵝": "鹅", "鮑": "鲍", "論": "论", "類": "类", "證": "证", "衝": "冲", "驗": "验", "計": "计", "項": "项", "憶": "忆", "熗": "炝", "鋼": "钢", "續": "续", "銷": "销", "鷗": "鸥", "額": "额", "獲": "获", "蹤": "踪", "慮": "虑", "薩": "萨", "圓": "圆", "訊": "讯", "況": "况", "結": "结", "該": "该", "賓": "宾", "儀": "仪", "遺": "遗", "築": "筑", "醃": "腌", "見": "见", "貨": "货", "濟": "济", "鍵": "键", "劉": "刘", "漬": "渍", "飽": "饱", "軒": "轩", "棧": "栈", "帥": "帅", "荊": "荆", "趙": "赵", "郵": "邮", "櫻": "樱", "吳": "吴", "莊": "庄", "盤": "盘", "釐": "厘", "燈": "灯", "鏡": "镜", "嚴": "严", "貓": "猫", "齡": "龄", "嘗": "尝", "陳": "陈", "別": "别", "羅": "罗", "紀": "纪", "沒": "没", "間": "间", "淵": "渊", "掃": "扫", "讀": "读", "醬": "酱", "階": "阶", "鯉": "鲤", "躥": "蹿", "壇": "坛", "繞": "绕", "灘": "滩", "鶴": "鹤", "鄒": "邹", "搶": "抢", "蝦": "虾", "燴": "烩", "羣": "群", "稅": "税", "歲": "岁", "豬": "猪", "誼": "谊", "繪": "绘", "豐": "丰", "磚": "砖", "嗆": "呛", "鰍": "鳅", "櫚": "榈", "試": "试", "棟": "栋", "態": "态", "賴": "赖", "稱": "称", "節": "节", "滷": "卤", "廂": "厢", "帳": "帐", "環": "环", "賦": "赋", "縮": "缩", "塗": "涂", "遜": "逊", "懷": "怀", "邏": "逻", "號": "号", "順": "顺", "樂": "乐", "質": "质", "筍": "笋", "钂": "镋", "舊": "旧", "個": "个", "萬": "万", "岡": "冈", "訓": "训", "囪": "囱", "濤": "涛", "飾": "饰", "貫": "贯", "橋": "桥", "韓": "韩", "貿": "贸", "溫": "温", "業": "业", "緒": "绪", "膠": "胶", "氳": "氲", "澆": "浇", "轉": "转", "著": "着", "鶉": "鹑", "臥": "卧", "湯": "汤", "蠍": "蝎", "鯊": "鲨", "內": "内", "歡": "欢", "黃": "黄", "蔭": "荫", "調": "调", "賣": "卖", "殞": "殒", "鵑": "鹃", "釋": "释", "亞": "亚", "驛": "驿", "題": "题", "雖": "虽", "雜": "杂", "響": "响", "餞": "饯", "爐": "炉", "漁": "渔", "茲": "兹", "魷": "鱿", "蹺": "跷", "報": "报", "鳳": "凤", "瀉": "泻", "鍾": "钟", "駕": "驾", "亂": "乱", "雲": "云", "時": "时", "農": "农", "勢": "势", "針": "针", "識": "识", "離": "离", "顏": "颜", "樞": "枢", "譽": "誉", "幫": "帮", "棗": "枣", "單": "单", "須": "须", "彈": "弹", "貴": "贵", "訂": "订", "層": "层", "勸": "劝", "滿": "满", "鎖": "锁", "藝": "艺", "撻": "挞", "擴": "扩", "廳": "厅", "長": "长", "獅": "狮", "職": "职", "蟲": "虫", "頁": "页", "嘆": "叹", "國": "国", "縉": "缙", "濁": "浊", "陸": "陆", "醫": "医", "缽": "钵", "釀": "酿", "傷": "伤", "評": "评", "擇": "择", "聖": "圣", "織": "织", "蘿": "萝", "膩": "腻", "粵": "粤", "檢": "检", "獎": "奖", "勁": "劲", "闊": "阔", "橫": "横", "腦": "脑", "動": "动", "劃": "划", "徑": "径", "擁": "拥", "勝": "胜", "駱": "骆", "尋": "寻", "蓋": "盖", "頂": "顶", "脫": "脱", "涼": "凉", "現": "现", "測": "测", "薔": "蔷", "設": "设", "輝": "辉", "鄉": "乡", "櫃": "柜", "愛": "爱", "數": "数", "賃": "赁", "納": "纳", "開": "开", "險": "险", "隕": "陨", "師": "师", "凱": "凯", "構": "构", "槓": "杠", "聶": "聂", "鹽": "盐", "確": "确", "劇": "剧", "銳": "锐", "鋭": "锐", "術": "术", "斷": "断", "轟": "轰", "脈": "脉", "頻": "频", "減": "减", "灣": "湾", "兇": "凶", "側": "侧", "販": "贩", "鬧": "闹", "騰": "腾", "風": "风", "溝": "沟", "館": "馆", "顯": "显", "託": "托", "魯": "鲁", "處": "处", "繼": "继", "牆": "墙", "鹹": "咸", "掛": "挂", "簷": "檐", "韻": "韵", "蒼": "苍", "約": "约", "絲": "丝", "寬": "宽", "湧": "涌", "蓮": "莲", "諾": "诺", "講": "讲", "軍": "军", "費": "费", "這": "这", "緊": "紧", "園": "园", "詳": "详", "護": "护", "貝": "贝", "蘆": "芦", "觀": "观", "窯": "窑", "龔": "龚", "進": "进", "饢": "馕", "會": "会", "萵": "莴", "聯": "联", "晉": "晋", "鎮": "镇", "餵": "喂", "張": "张", "維": "维", "積": "积", "購": "购", "機": "机", "與": "与", "綠": "绿", "閱": "阅", "閲": "阅", "專": "专", "鷹": "鹰", "曉": "晓", "勞": "劳", "釣": "钓", "譚": "谭", "恆": "恒", "適": "适", "屬": "属", "關": "关", "霧": "雾", "紉": "纫", "鍋": "锅", "卧": "臥", "蟬": "蝉", "俠": "侠", "疊": "叠", "軌": "轨", "兒": "儿", "騎": "骑", "籠": "笼", "畝": "亩", "語": "语", "鷺": "鹭", "飛": "飞", "璽": "玺", "戲": "戏", "騾": "骡", "邁": "迈", "餃": "饺", "撲": "扑", "級": "级", "樹": "树", "將": "将", "戶": "户", "對": "对", "欖": "榄", "書": "书", "啟": "启", "啓": "启", "擼": "撸", "鴦": "鸯", "蘇": "苏", "總": "总", "畫": "画", "採": "采", "卻": "却", "認": "认", "廬": "庐", "鬱": "郁", "寶": "宝", "溼": "湿", "濕": "湿", "優": "优", "練": "练", "儲": "储", "覺": "觉", "彌": "弥", "暫": "暂", "電": "电", "歷": "历", "輪": "轮", "據": "据", "縫": "缝", "權": "权", "煙": "烟", "蔥": "葱", "絡": "络", "趕": "赶", "話": "话", "鄰": "邻", "陝": "陕", "灩": "滟", "絨": "绒", "陣": "阵", "傳": "传", "籤": "签", "軟": "软", "爾": "尔", "覓": "觅", "榮": "荣", "飄": "飘", "户": "戶", "禪": "禅", "養": "养", "鐵": "铁", "冊": "册", "塊": "块", "價": "价", "願": "愿", "靈": "灵", "箏": "筝", "巔": "巅", "馬": "马", "攜": "携", "龐": "庞", "潤": "润", "藍": "蓝", "靜": "静", "無": "无", "難": "难", "盡": "尽", "鎢": "钨", "槳": "桨", "異": "异", "終": "终", "紋": "纹", "達": "达", "際": "际", "懸": "悬", "穩": "稳", "紅": "红", "並": "并", "龍": "龙", "饞": "馋", "麼": "么", "鴉": "鸦", "鯽": "鲫", "線": "线", "錯": "错", "鑑": "鉴", "樓": "楼", "紙": "纸", "燉": "炖", "駁": "驳", "詩": "诗", "氣": "气", "壩": "坝", "來": "来", "場": "场", "髒": "脏", "記": "记", "凍": "冻", "欄": "栏", "隨": "随", "賀": "贺", "廚": "厨", "錫": "锡", "豔": "艳", "綿": "绵", "奧": "奥", "廟": "庙", "薈": "荟", "頌": "颂", "饊": "馓", "遷": "迁", "強": "强", "滾": "滚", "雞": "鸡", "鴨": "鸭", "準": "准", "眾": "众", "匯": "汇", "邊": "边", "聽": "听", "賞": "赏", "讓": "让", "隊": "队", "從": "从", "贊": "赞", "鱔": "鳝", "歸": "归", "兩": "两", "貳": "贰", "鰱": "鲢", "條": "条", "營": "营", "叢": "丛", "庫": "库", "攤": "摊", "嗎": "吗", "蠅": "蝇", "談": "谈", "窩": "窝", "繕": "缮", "鏈": "链", "純": "纯", "漸": "渐", "紡": "纺", "陽": "阳", "禮": "礼", "興": "兴", "慶": "庆", "壓": "压", "鯨": "鲸", "摻": "掺", "燒": "烧", "剛": "刚", "鬥": "斗", "訪": "访", "標": "标", "鳥": "鸟", "實": "实", "為": "为", "辦": "办", "選": "选", "藥": "药", "夠": "够", "賽": "赛", "黨": "党", "財": "财", "澤": "泽", "峯": "峰", "鳴": "鸣", "温": "溫", "樣": "样", "燻": "熏", "壯": "壮", "埡": "垭", "覽": "览", "僅": "仅", "蔣": "蒋", "廝": "厮", "擋": "挡", "圍": "围", "領": "领", "詢": "询", "發": "发", "燙": "烫", "瀾": "澜", "譜": "谱", "葉": "叶", "漢": "汉", "課": "课", "鈔": "钞", "鹼": "碱", "負": "负", "繹": "绎", "暢": "畅", "彎": "弯", "謂": "谓", "預": "预", "買": "买", "隱": "隐", "輛": "辆", "窮": "穷", "則": "则", "腸": "肠", "錦": "锦", "戰": "战", "餅": "饼", "鉑": "铂", "銀": "银", "猶": "犹", "腳": "脚", "剎": "刹", "應": "应", "嶽": "岳", "臘": "腊", "么": "幺", "紹": "绍", "學": "学", "帶": "带", "燜": "焖", "範": "范", "羶": "膻", "議": "议", "佔": "占", "顧": "顾", "災": "灾", "寵": "宠", "濃": "浓", "變": "变", "艙": "舱", "撈": "捞", "較": "较", "崗": "岗", "狀": "状", "細": "细", "載": "载", "紗": "纱", "滄": "沧", "筆": "笔", "換": "换", "鑽": "钻", "頭": "头", "銅": "铜", "華": "华", "廈": "厦", "熱": "热", "極": "极", "視": "视", "瘋": "疯", "魚": "鱼", "巖": "岩", "嶺": "岭", "壽": "寿", "簡": "简", "擔": "担", "崍": "崃", "縱": "纵", "東": "东", "寧": "宁", "媽": "妈", "懶": "懒", "擬": "拟", "產": "产", "曬": "晒", "決": "决", "夥": "伙", "飪": "饪", "麗": "丽", "鵪": "鹌", "綜": "综", "餡": "馅", "薦": "荐", "參": "参", "閉": "闭", "朧": "胧", "經": "经", "諸": "诸", "礦": "矿", "輯": "辑", "葷": "荤", "許": "许", "夢": "梦", "貼": "贴", "閣": "阁", "銜": "衔", "給": "给", "編": "编", "還": "还", "團": "团", "種": "种", "棲": "栖", "謠": "谣", "裝": "装", "閃": "闪", "務": "务", "說": "说", "説": "说", "迴": "回", "係": "系", "禦": "御", "韆": "千", "糰": "团", "驚": "惊", "鱂": "鳉", "複": "复", "膽": "胆", "垻": "坝", "菸": "烟", "薑": "姜", "罈": "坛", "闆": "板", "捨": "舍", "孃": "娘", "聰": "聪", "誌": "志", "臟": "脏", "檯": "台", "鬆": "松", "併": "并", "鐘": "钟", "蹟": "迹", "儘": "尽", "穀": "谷", "緻": "致", "紮": "扎", "註": "注", "週": "周", "緣": "缘", "蔔": "卜", "畢": "毕", "製": "制", "輸": "输", "盪": "荡", "鞦": "秋"};
